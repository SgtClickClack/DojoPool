...
class EncodingFixer:
    def __init__(self, root_dir: str):
        ...
        self.ignored_dirs = {
            ...
            'build', 'dist', '.pytest_cache', '.venv', 'venv_new'
        }
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler(log_dir / f'encoding_fix_{datetime.now().strftime("%Y%m%d_%H%M%S")}.log'),
    ...
    def create_backup(self, file_path: Path) -> Path:
        ...
        backup_dir = self.root_dir / 'backups' / 'encoding_fixes' / datetime.now().strftime("%Y%m%d_%H%M%S")
