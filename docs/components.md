...
<!-- Valid State -->
<div class="form-group">
  <input type="text" class="form-control is-valid" aria-invalid="false" />
  <div class="form-feedback valid">Looks good!</div>
</div>

<!-- Invalid State -->
<div class="form-group">
  <input type="text" class="form-control is-invalid" aria-invalid="true" />
...
<nav class="navbar" role="navigation">
  ...
  <div class="navbar-menu">
    ...
    <div class="navbar-dropdown">
      <button class="navbar-dropdown-toggle" aria-expanded="false">More</button>
...
```html
<button class="btn" data-tooltip="Tooltip text" aria-describedby="tooltip-1">
  Hover me
</button>
<div id="tooltip-1" class="tooltip" role="tooltip">Tooltip text</div>
```

### Positioned Tooltip

```html
<button class="btn" data-tooltip="Top tooltip" data-tooltip-position="top">
  Top
</button>
```
...
```html
<img class="avatar" src="user.jpg" alt="User name" />
```
