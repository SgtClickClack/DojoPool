...
if (fs.existsSync(envLocalPath)) {
  ...
  console.log('💡 If you need to update Firebase config, run: npm run validate-firebase');
  process.exit(0);
}

// Check if main .env exists
if (!fs.existsSync(envPath)) {
  console.error('❌ .env file not found. Please ensure you have the main environment file.');
  process.exit(1);
}
