...
async function processAssets() {
  try {
    ...
    for (const file of imageFiles) {
      ...
      await uploadToS3(webpBuffer, `images/${relativePath}.webp`, 'image/webp');
      ...
      await uploadToS3(avifBuffer, `images/${relativePath}.avif`, 'image/avif');
    ...
    for (const file of staticFiles) {
      ...
      await uploadToS3(buffer, relativePath, getContentType(file));
    }
