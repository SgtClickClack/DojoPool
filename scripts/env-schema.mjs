...
const schema = {
  required: {
    ...
    backend: {
      ...
      JWT_SECRET: { hint: 'Use a long, random string for JWT signing (see config.env placeholder)' },
    },
    cache: {
      REDIS_URL: { example: 'redis://localhost:6379', hint: 'Redis connection string for cache/queues' }
    },
