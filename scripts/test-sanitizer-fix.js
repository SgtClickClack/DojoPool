...
const { advancedSanitizeHTML, SECURITY_CONFIG } = require('../src/utils/securityUtils');
...
const testCases = [
  ...
  },
  {
    ...
    input: '<div>Level 1 <p>Level 2 <span>Level 3</span> back to 2</p> back to 1</div>',
...
console.log('🎉 Test completed. Mixed content ordering should now be preserved!');