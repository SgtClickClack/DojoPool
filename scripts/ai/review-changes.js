...
async function main() {
  ...
  const user = 'Review the following git diff and provide feedback grouped by file.\n\n' + diff;
  const output = await chatComplete({ system, user, maxTokens: 2048, temperature: 0.2 });
