...
function showChallengeNotification(data) {
    ...
    notification.className = 'alert alert-info alert-dismissible fade show position-fixed top-50 start-50 translate-middle';
...
function showChallengeStarted(data) {
    ...
    scoreboard.className = 'position-fixed top-0 end-0 m-3 bg-dark p-3 rounded shadow';
