class LeaderboardManager {
    ...
    async loadLeaderboard() {
        try {
            const response = await fetch(`/api/leaderboard?category=${this.currentCategory}&period=${this.currentPeriod || ''}`);
    ...
    renderLeaderboard(entries) {
        const tableBody = document.getElementById(`${this.currentCategory}Leaderboard`);
        tableBody.innerHTML = '';
