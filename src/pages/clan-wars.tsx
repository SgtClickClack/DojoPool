...
// import { useClanSystem } from '../../../../../apps/web/src/hooks/useClanSystem';
...
const ClanWarsPage: React.FC = () => {
  ...
  const activeClanWars = [];
  const loading = false;
  const declareWar = async (targetClanId: string, warData: any) => true;
  const acceptWar = async () => true;
  const submitWarMatch = async () => true;
