    ...
    <CyberpunkContainer maxWidth={false}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ color: 'text.secondary', mb: 3 }}>
          IoT sensors, camera systems, and real-time data collection for AI model training
        </Typography>
      ...
      <Box sx={{ mb: 4 }}>
        <CyberpunkPaper sx={{ p: 3 }}>
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary', mb: 2 }}>
            Our advanced IoT sensors and camera systems provide real-time data collection for AI model training and match analysis.
          </Typography>
          <Typography variant="body2" sx={{ color: 'text.secondary' }}>
            Features: 4K Camera Systems • Multi-Sensor Arrays • Edge Computing • Real-time Processing • AI Model Training
          </Typography>
        </CyberpunkPaper>
      </Box>
