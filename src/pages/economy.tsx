...
// import { DojoCoinEconomyPanel } from '../../../../../apps/web/src/components/economy/DojoCoinEconomyPanel';
// import { type DojoCoinTransaction } from '../../../../../apps/web/src/services/economy/DojoCoinEconomyService';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-gray-600">
            Economy panel temporarily unavailable. This component will be
