...
import TournamentBracket from '../components/Tournament/[TOURN]TournamentBracket';
...
export const TournamentManagement: React.FC = () => {
  ...
  const handleMatchClick = async (match: TournamentMatch) => {
    if (
      ...
      parseInt(user.id) === selectedTournament.id
    ) {
                        ...
                        <Grid item xs>
                          ...
                          >
                            ...
                            <Chip
                              ...
                              sx={{
                                backgroundColor: `rgba(${getFormatColor(
                                  tournament.format
                                )}, 0.2)`,
                                color: getFormatColor(tournament.format),
                                border: `1px solid ${getFormatColor(
                                  tournament.format
                                )}`,
                                fontWeight: 'bold',
                                textShadow: '0 0 5px currentColor',
