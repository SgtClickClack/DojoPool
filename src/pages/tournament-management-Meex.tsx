...
const TournamentManagementPage: React.FC = () => {
  ...
  const handleMatchComplete = (matchId: string, winnerId: string, loserId: string) => {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage tournaments with AI commentary, Pool God interactions, and enhanced rewards
          </p>
        </div>
                  ...
                  {tournaments.map((tournament) => (
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-600 space-y-1">
                        ...
                        <div>Participants: {tournament.participants.length}/{tournament.maxParticipants}</div>
                        <div>Prize Pool: {tournament.prizePool} DC</div>
                        <div>Entry Fee: {tournament.entryFee} DC</div>
                        <div className={`inline-block px-2 py-1 rounded text-xs font-medium ${getStatusColor(tournament.status)}`}>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mt-6">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    onClick={() => {
                      console.log('Test AI Commentary for tournament:', selectedTournamentId);
                    }}
                  >
                    Test AI Commentary
                  </button>
                  <button
                    ...
                    onClick={() => {
                      console.log('Test Pool God Interaction for tournament:', selectedTournamentId);
                    }}
                  >
                  ...
                  <button
                    ...
                    onClick={() => {
                      console.log('Test Rewards Distribution for tournament:', selectedTournamentId);
                    }}
                  >
            ...
            {selectedTournamentId ? (
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">
                    Choose a tournament from the sidebar to view its details and manage matches.
                  </p>
                </div>
              </div>
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-semibold text-green-800">AI Commentary</div>
            ...
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-semibold text-blue-800">Pool God System</div>
            ...
            <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-semibold text-purple-800">Reward System</div>
