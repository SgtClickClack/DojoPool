    ...
    <CyberpunkContainer maxWidth={false}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ color: 'text.secondary', mb: 3 }}>
          Optimized tournament experience for mobile devices with offline capabilities and push notifications
        </Typography>
      ...
      <Box sx={{ mb: 4 }}>
        <CyberpunkPaper sx={{ p: 3 }}>
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary', mb: 2 }}>
            Access all tournament features on your mobile device with optimized performance and offline capabilities
          </Typography>
          ...
          <CyberpunkPaper sx={{ p: 3, mb: 3 }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <Box>
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  Real-time alerts for tournament updates, match results, and achievements
                </Typography>
              </Box>
              <Box>
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  Access tournament data and features without internet connection
                </Typography>
              </Box>
              <Box>
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  Low data mode and optimized loading for better mobile experience
                </Typography>
              </Box>
            </Box>
          </CyberpunkPaper>
