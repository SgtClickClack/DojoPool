  ...
  const demoEvents = [
    {
      ...
      description: 'Complete the basic tutorial to unlock your first avatar features',
      type: 'achievement',
      status: 'completed'
    },
    {
      ...
      <Container maxWidth="xl">
        <Box sx={{ py: 4 }}>
          ...
          <Alert severity="info" sx={{ mb: 4 }}>
            Experience the immersive narrative-driven progression system where your pool skills unlock story arcs, 
            character interactions, and avatar evolution. Every match, every victory, and every interaction shapes your journey.
          </Alert>
                  ...
                  <Grid item xs={12} md={6} lg={4} key={event.id}>
                    <Card 
                      sx={{ 
                        ...
                        borderColor: event.status === 'completed' ? 'success.main' : 'divider'
                      }}
                    >
                      <CardContent>
                  ...
                  <Card>
                    <CardContent>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Unlock avatar features and story progress through achievements
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                  <Card>
                    <CardContent>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Match outcomes trigger narrative consequences and character interactions
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                  <Card>
                    <CardContent>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Major plot points that advance story arcs and unlock new content
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                  <Card>
                    <CardContent>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Visiting different venues triggers unique narrative experiences
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
                ...
                <Grid item xs={12} sm={6} md={3}>
                  <Card>
                    <CardContent>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Wise characters who guide your progression and unlock advanced features
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                  <Card>
                    <CardContent>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Challenging opponents who drive story arcs and test your skills
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                  <Card>
                    <CardContent>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Supportive characters who provide bonuses and unlock social features
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
                <Grid item xs={12} sm={6} md={3}>
                  <Card>
                    <CardContent>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        Antagonistic characters who create challenges and story conflicts
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                  ...
                  <ul>
                    ...
                    <li>Character interactions with personality-driven dialogue</li>
                    <li>World state changes based on events and player choices</li>
                    <li>Real-time narrative commentary from Pool Gods</li>
                    <li>Location-based story triggers and character encounters</li>
                  </ul>
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="h6" gutterBottom>
