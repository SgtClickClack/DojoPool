...
describe('useStorage', () => {
  ...
  it('should upload a file', async () => {
    ...
    (storage.getDownloadURL as jest.Mock).mockResolvedValue('https://example.com/test.jpg');
  ...
  it('should upload a profile image', async () => {
    (storage.uploadBytes as jest.Mock).mockResolvedValue({ ref: {} });
    (storage.getDownloadURL as jest.Mock).mockResolvedValue('https://example.com/profile.jpg');
  ...
  it('should upload a game recording', async () => {
    (storage.uploadBytes as jest.Mock).mockResolvedValue({ ref: {} });
    (storage.getDownloadURL as jest.Mock).mockResolvedValue('https://example.com/game.mp4');
  ...
  it('should upload a venue image', async () => {
    (storage.uploadBytes as jest.Mock).mockResolvedValue({ ref: {} });
    (storage.getDownloadURL as jest.Mock).mockResolvedValue('https://example.com/venue.jpg');
