...
const mockRef = {
  ...
  getDownloadURL: jest.fn(() => Promise.resolve('https://example.com/test-file')),
  delete: jest.fn(() => Promise.resolve()),
  getMetadata: jest.fn(() => Promise.resolve({ name: 'test-file', size: 1024 })),
  updateMetadata: jest.fn(() => Promise.resolve({ name: 'test-file', size: 1024 })),
