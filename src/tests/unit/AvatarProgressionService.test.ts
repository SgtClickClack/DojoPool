import { AvatarProgressionService, AvatarProgression, StoryArc, StoryAchievement, VenueMastery } from '../../services/avatar/AvatarProgressionService';
...
describe('AvatarProgressionService', () => {
  ...
  describe('initialization', () => {
    ...
    it('should create new user progression with default values', () => {
      ...
      expect(progression.visualProgression.baseAvatar).toBe('/models/default-avatar.glb');
      expect(progression.visualProgression.currentOutfit).toBe('beginner_outfit');
    });
  ...
  describe('visual progression', () => {
    ...
    it('should update current outfit', () => {
      ...
      const visualProgression = service.getVisualProgression('user-1');
      expect(visualProgression.currentOutfit).toBe('tournament_champion_outfit');
    });
    ...
    it('should add and remove accessories', () => {
      ...
      expect(visualProgression.currentAccessories).not.toContain('test_accessory');
    });
  });
  ...
  describe('pool god blessings', () => {
    it('should grant pool god blessing', () => {
      service.grantPoolGodBlessing('user-1', 'AI Umpire', 'Enhanced accuracy', 60);
