...
class Shot(db.Model):
    ...
    def __init__(self, game_id: int, player_id: int, shot_type: ShotType, 
                 result: ShotResult, difficulty: Optional[float] = None,
                 speed: Optional[float] = None, spin: Optional[str] = None,
                 angle: Optional[float] = None, position_data: Optional[Dict] = None):
