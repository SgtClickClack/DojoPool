export class ConnectionManager {
    ...
    handleConnectionChange() {
        ...
        const prevQuality = this.state.networkQuality;
    ...
    scheduleRetry() {
        ...
        const delay = Math.min(this.retryDelay * Math.pow(2, this.retryAttempts), this.maxDelay);
    ...
    dispatchEvent(type, detail = {}) {
        const event = new CustomEvent(`connection:${type}`, { detail });
