...
async def get_optimization_recommendations(
    current_user=Depends(get_current_user), db=Depends(get_db), redis=Depends(get_redis)
):
...
async def get_performance_alerts(
    ...
    try:
        ...
        return {"success": True, "data": {"alerts": issues, "analysis": analysis}}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
...
async def update_alert_thresholds(
    ...
    try:
        ...
        return {"success": True, "data": monitor.alert_thresholds}
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
