...
from dojopool.core.extensions import cache, socketio
...
class NotificationManager:
    ...
    def emit_game_update(game_id, update_type, data):
        ...
        """
        update = {"type": update_type, "data": data, "timestamp": time.time()}

        socketio.emit("game_update", update, room=f"game_{game_id}")
    ...
    def emit_venue_update(venue_id, update_type, data):
        ...
        socketio.emit("venue_update", update, room=f"venue_{venue_id}")
