...
const DebugPanel: React.FC = () => {
    ...
    const StatusIndicator = useMemo(() => {
        ...
        const latestMetrics = metrics[metrics.length - 1] || { latency: 0, bandwidth: 0, packetLoss: 0 };
        ...
        return (
            <Box display="flex" alignItems="center" gap={2}>
                ...
                <Tooltip title={`Latency: ${latestMetrics.latency.toFixed(0)}ms, Bandwidth: ${latestMetrics.bandwidth.toFixed(1)}Mbps`}>
                    ...
                    <AccordionDetails>
                        {metrics ? (
                            <>
                                ...
                                {warningCount > 0 && (
                                    <Box>
                                        <Typography color="warning" variant="subtitle2" gutterBottom>
