...
export const OptimizedImage: React.FC<OptimizedImageProps> = ({ baseUrl, alt, ...props }) => {
...
export const ResponsiveImage: React.FC<ResponsiveImageProps> = ({ imageSizes, alt, ...props }) => {
  ...
  const fallbackSrc = imageSizes.xl || imageSizes.lg || imageSizes.md || imageSizes.sm || "";
