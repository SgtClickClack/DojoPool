...
import { 
    Card, Tabs, Button, Space, Tag, Table, Modal, Form,
    Input, InputNumber, message, Descriptions, Timeline, Select
} from 'antd';
import { 
...
import {
    getTournament, getTournamentMatches, updateMatch,
    registerForTournament, generateBracket
                    ...
                    <Space align="start" size="large">
                        <div>
                            ...
                            <Tag color={
                                ...
                                tournament.status === 'in_progress' ? 'processing' :
                                tournament.status === 'registration' ? 'warning' :
                                tournament.status === 'cancelled' ? 'error' : 'default'
                            }>
