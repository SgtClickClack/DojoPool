                ...
                >
                    ...
                    <Space size="large">
                        <Form.Item
                            ...
                            rules={[
                                { type: 'number', min: 2, message: 'Must have at least 2 participants' }
                            ]}
                        >
                            <InputNumber min={2} />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            label="Entry Fee"
                            rules={[
                                { type: 'number', min: 0, message: 'Entry fee cannot be negative' }
                            ]}
                        >
                            <InputNumber
                                min={0}
                        ...
                        <Form.Item
                            ...
                            label="Prize Pool"
                            rules={[
                                { type: 'number', min: 0, message: 'Prize pool cannot be negative' }
                            ]}
                        >
                            <InputNumber
                                min={0}
