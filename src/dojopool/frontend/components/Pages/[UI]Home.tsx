        ...
        const mockGames: Game[] = [
          {
            ...
            title: "City Explorer",
            description:
              "Discover hidden gems in your city through an exciting scavenger hunt!",
          ...
          },
          {
            ...
            title: "Nature Trail",
            description:
              "Connect with nature while solving riddles and finding treasures.",
      ...
      <Box
        sx={{
          ...
          "&::before": {
            ...
            bottom: 0,
            background:
              "linear-gradient(45deg, rgba(0,255,157,0.1) 0%, rgba(0,168,255,0.1) 100%)",
            zIndex: -1,
          },
        }}
      >
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              <Box className="fade-in">
                ...
                >
                  Master the art of pool with AI-powered training, analytics,
