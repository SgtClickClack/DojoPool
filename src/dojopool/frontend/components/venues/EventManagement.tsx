...
import {
    ...
    Input, DatePicker, InputNumber, Select,
    Row, Col, Statistic, Tooltip, message,
    List, Avatar
} from 'antd';
import {
...
import {
    getVenueEvents, createEvent, updateEvent,
                        ...
                        <List.Item
                            actions={[
                                isOwner && !item.checked_in && (
                                    <Button
                                        type="link"
                                        onClick={() => handleCheckIn(selectedEvent.id, item.user_id)}
                                    >
                                        Check In
                                    </Button>
                                )
