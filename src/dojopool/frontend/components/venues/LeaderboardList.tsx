...
import {
    ...
    Statistic, Avatar, Tooltip, Button,
    message
} from 'antd';
import {
        ...
        },
        {
            ...
            render: (record: any) => (
                <Tooltip title={`Highest: ${record.highest_streak}`}>
                    <Tag
                        color={record.current_streak > 0 ? 'success' :
                              record.current_streak < 0 ? 'error' :
                              'default'}
                    >
                        {record.current_streak > 0 ? '+' : ''}{record.current_streak}
                    </Tag>
                </Tooltip>
            )
        },
                ...
                <Row gutter={[16, 16]} className="stats-row">
                    ...
                    <Col xs={12} sm={8} md={6}>
                        <Statistic
                            ...
                            prefix={<FireOutlined />}
                            valueStyle={{
                                color: userStats.current_streak > 0 ? '#3f8600' :
                                       userStats.current_streak < 0 ? '#cf1322' :
                                       undefined
                            }}
                        />
                    </Col>
