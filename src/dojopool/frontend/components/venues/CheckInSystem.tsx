...
import {
    Card, Button, Table, Tag, Modal, Form,
    Input, Select, Tabs, Statistic, Row, Col,
    Timeline, message
} from 'antd';
import {
...
import {
    checkIn, checkOut, getActiveCheckins,
    getCheckinHistory, getOccupancyStats
} from '../../api/venues';
...
const CheckInSystem: React.FC<CheckInSystemProps> = ({ venueId, venueName }) => {
    ...
    return (
        <div className="check-in-system">
            <Card
                title={<><TeamOutlined /> Check-in System</>}
                extra={
                    isCheckedIn ? (
                        <Button
                            type="primary"
            ...
            >
                <Tabs defaultActiveKey="active">
                    <TabPane
                        tab={<span><TeamOutlined /> Active Players</span>}
                        key="active"
                    >
                    ...
                    <TabPane
                        tab={<span><ClockCircleOutlined /> Check-in History</span>}
                        key="history"
                    >
                        <Table
                    ...
                    <TabPane
                        tab={<span><BarChartOutlined /> Occupancy Trends</span>}
                        key="trends"
                    >
