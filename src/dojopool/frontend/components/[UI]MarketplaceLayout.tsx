...
export const MarketplaceLayout: React.FC = () => {
  ...
  const handleSearch = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    navigate(
      `/marketplace?search=${event.target.value}&category=${category}&sort=${sortBy}`,
    );
  };
  ...
  const handleCategoryChange = (
    ...
    navigate(
      `/marketplace?search=${searchTerm}&category=${event.target.value}&sort=${sortBy}`,
    );
  };
  ...
  const handleSortChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    navigate(
      `/marketplace?search=${searchTerm}&category=${category}&sort=${event.target.value}`,
    );
  };
