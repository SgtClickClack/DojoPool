...
class StorageService {
    ...
    public async getTrainingSession(id: string): Promise<TrainingSession | undefined> {
        await this.ensureDB();
    ...
    public async getOfflineActions(): Promise<Array<{
        id: string;
        action: string;
        data: any;
        timestamp: string;
    ...
    // Cache Management
    public async cacheResponse(url: string, data: any, ttl: number = 3600000): Promise<void> {
        await this.ensureDB();
    ...
    public async clearAll(): Promise<void> {
        await this.ensureDB();
        const stores = ['trainingSessions', 'userProfiles', 'offlineActions', 'cachedResponses'];
