...
export async function createTrainingSession(session: Partial<TrainingSession>): Promise<TrainingSession> {
...
export async function submitFeedback(sessionId: string, feedback: Partial<TrainingFeedback>): Promise<TrainingFeedback> {
