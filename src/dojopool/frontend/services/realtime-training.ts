...
class RealTimeTrainingService {
    ...
    public sendFeedback(sessionId: string, feedback: {
        techniqueId: string;
        rating: number;
        comments?: string;
    }): void {
    ...
    public requestInstructorHelp(sessionId: string, details: {
        techniqueId: string;
        difficulty: string;
        question?: string;
    }): void {
    ...
    public startLiveSession(sessionId: string, config: {
    ...
    public sendMessage(sessionId: string, message: {
        text: string;
