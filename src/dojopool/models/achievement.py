...
class Achievement(BaseModel):
    ...
    @classmethod
    def get_by_category(cls, category: str, active_only: bool = True) -> List["Achievement"]:
...
class UserAchievement(BaseModel):
    ...
    def get_user_achievements(
        cls, user_id: int, completed: Optional[bool] = None
    ...
    def get_achievement_users(
        cls, achievement_id: int, completed: Optional[bool] = None
    ) -> List["UserAchievement"]:
    ...
    def create_user_achievement(
        cls, user_id: int, achievement_id: int, progress: Optional[Dict[str, Any]] = None
    ) -> "UserAchievement":
        """Create a new user achievement."""
        user_achievement = cls(
            user_id=user_id, achievement_id=achievement_id, progress=progress or {}
        )
