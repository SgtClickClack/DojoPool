...
class ResponsiveImageGenerator:
    ...
    def _create_responsive_version(self, img: PILImage.Image, breakpoint: ImageBreakpoint, 
                                 output_path: str, original_format: str) -> Tuple[str, int]:
    ...
    def add_responsive_loading(self, html_file: str) -> None:
        ...
        try:
            ...
            for match in img_tags:
                ...
                new_img_tag = img_tag.replace('<img', '<img loading="eager"' if is_critical else '<img loading="lazy"')
