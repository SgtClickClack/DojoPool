...
def main():
    ...
    parser.add_argument('--output-dir', '-o', default='static/images',
    ...
    try:
        ...
        webp_ratios = [r.compression_ratio for r in results['webp'] if r.success and r.compression_ratio]
        opt_ratios = [r.compression_ratio for r in results['optimized'] if r.success and r.compression_ratio]
