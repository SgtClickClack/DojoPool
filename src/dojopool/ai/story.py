...
class StoryGenerator:
    ...
    def generate_tournament_story(self, tournament_data: Dict[str, Any], style: str = 'dramatic') -> str:
    ...
    def _build_tournament_context(self, tournament_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'players': [p.get('username', f'Player {i+1}') for i, p in enumerate(tournament_data.get('players', []))],
