...
from ..models import Match, Game, Event, Shot
...
class MatchAnalyzer:
    ...
    async def analyze_match(self, match_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            match = await db.session.query(Match).options(
    ...
    def _get_empty_analysis(self) -> Dict[str, Any]:
        ...
        return {
            'match_summary': cast(MatchSummary, {
                'match_id': 0,
                'player1': "",
                'player2': "",
                'score': "0-0",
            ...
            'key_moments': [],
            'performance_stats': cast(AnalysisMetrics, {
                'shot_accuracy': 0.0,
