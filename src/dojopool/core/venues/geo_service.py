...
class GeoService:
    ...
    def find_nearby_dojos(self, lat: float, lng: float, radius_km: Optional[float] = None) -> List[Dict]:
    ...
    def get_regional_leaderboard(self, lat: float, lng: float, radius_km: Optional[float] = None) -> List[Dict]:
