...
class StoryManager:
                ...
                with open(story_file, 'r') as f:
                    ...
                    for node_data in data['nodes']:
                        node = StoryNode(
                            ...
                            achievement_type=AchievementType(node_data.get('achievement_type'))
                            if node_data.get('achievement_type') else None,
                            skill_level=SkillLevel(node_data.get('skill_level'))
                            if node_data.get('skill_level') else None
                        )
    ...
    def get_next_story_nodes(self, current_node_id: str, player_achievements: List[str]) -> List[StoryNode]:
    ...
    def _check_requirements(self, requirements: Dict[str, Any], player_achievements: List[str]) -> bool:
