...
from .compression import ImageCompressionService, CompressionConfig, ImageFormat, BatchProcessingResult
            ...
            for size in image_sizes:
                for chunk_size in chunk_sizes:
                    ...
                    try:
                        ...
                        logger.info(f"  Failed images: {metrics.failed_images}/{metrics.total_images}")
        ...
        with tempfile.TemporaryDirectory() as input_dir, tempfile.TemporaryDirectory() as output_dir:
            ...
            try:
                while time.time() - start_time < duration_seconds:
                    ...
                    iteration += 1
                    if iteration % 5 == 0:
                        logger.info(f"Completed {iteration} iterations. Current memory: {memory_after:.2f} MB")
