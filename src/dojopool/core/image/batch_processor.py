...
class BatchImageProcessor:
    ...
    def process_directory(
        ...
        try:
            ...
            result.errors.append({"type": "directory_error", "message": str(e)})
            return result
    ...
    def _process_chunk(
        ...
        with ThreadPoolExecutor(max_workers=self._max_workers) as executor:
            ...
            future_to_file = {
                executor.submit(
                    self._process_single_file, input_file, output_dir, config
                ): input_file
            ...
            for future in as_completed(future_to_file):
                ...
                try:
                    ...
                    result.failed += 1
                    result.errors.append({"file": str(input_file), "error": str(e)})

    def _process_single_file(
        self, input_file: Path, output_dir: Path, config: CompressionConfig
    ) -> tuple[bool, int, int]:
        """
