...
from ..experiment_analyzer import ExperimentAnalyzer, AnalysisResult
...
class ExperimentDashboard:
    ...
    def generate_report(self, experiment_id: str) -> str:
        ...
        for metric_name, metric_data in summary["metrics"].items():
            significance_class = "significant" if metric_data["is_significant"] else "not-significant"
            html += f"""
