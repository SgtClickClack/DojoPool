...
class Notification(BaseModel):
    ...
    type = db.Column(db.String(50), nullable=False)  # game_invite, match_start, tournament_update, etc.
...
class NotificationPreference(BaseModel):
    ...
    id = db.Column(db.Integer, primary_key=True)
    user_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=False)
    notification_type = db.Column(db.String(50), nullable=False)  # achievement, tournament, friend_request, etc.
