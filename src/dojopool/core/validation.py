...
class UserSchema(Schema):
    ...
    username = fields.Str(
        required=True,
        validate=validate.Regexp(r'^[a-zA-Z0-9_-]{3,32}$')
    )
...
class InputValidator:
    ...
    def validate_game_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """Validate game data.
        ...
        try:
            ...
            # Additional validation
            if ('min_players' in validated and 'max_players' in validated and
    ...
    def validate_file_upload(self, file: Any, allowed_types: List[str], max_size: int) -> bool:
