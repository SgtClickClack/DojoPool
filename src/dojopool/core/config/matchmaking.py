...
SKILL_LEVELS = {
    "beginner": {"range": (0, 1000), "max_diff": 200, "description": "New to the game"},
    "intermediate": {
        "range": (1001, 2000),
        "max_diff": 300,
...
LOCATION_SETTINGS = {
    ...
    "minimum_venues": 2,
    "venue_weights": {"distance": 0.4, "rating": 0.3, "availability": 0.3},
}
...
QUEUE_SETTINGS = {
    ...
    "priority_levels": {"vip": 3, "premium": 2, "standard": 1},
    "timeout": 600,  # seconds
}
