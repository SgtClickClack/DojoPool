...
class VenueError(APIError):
    ...
    def __init__(self, message: str = "Venue operation failed", details: Optional[Dict[str, Any]] = None) -> None:
...
class PaymentError(APIError):
    ...
    def __init__(self, message: str = "Payment operation failed", details: Optional[Dict[str, Any]] = None) -> None:
...
class NotificationError(APIError):
    ...
    def __init__(self, message: str = "Notification operation failed", details: Optional[Dict[str, Any]] = None) -> None:
...
class AchievementError(APIError):
    ...
    def __init__(self, message: str = "Achievement operation failed", details: Optional[Dict[str, Any]] = None) -> None:
