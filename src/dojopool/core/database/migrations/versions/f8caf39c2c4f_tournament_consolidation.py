"""tournament_consolidation

Revision ID: f8caf39c2c4f
Revises: 
...
def upgrade() -> None:
    ...
    op.add_column('tournament_prizes', sa.Column('distribution_status', sa.String(20), nullable=True))
