...
def create_reward_tiers():
    ...
    reward_tiers = [
        ...
        },
        {
            ...
            'benefits': ['exclusive_achievements', 'tournament_vip', 'venue_priority', 'special_events']
        }
    ]
...
def create_pricing_plans():
    ...
    pricing_plans = [
        ...
        },
        {
            ...
            'price': 9.99,
            'billing_interval': 'monthly',
            'features': ['play_games', 'join_tournaments', 'priority_registration', 'stats_tracking']
        },
        {
            'name': 'Pro',
            ...
            'price': 19.99,
            'billing_interval': 'monthly',
            'features': ['play_games', 'join_tournaments', 'priority_registration', 'stats_tracking', 'coaching', 'video_analysis']
        }
    ]
