...
EVENTS = {
    'connect': {
        ...
        'response': {
            'type': 'boolean',
            'description': 'True if connection successful'
        }
    },
    'disconnect': {
    ...
    'join_game': {
        ...
        'response': {
            'type': 'boolean',
            'description': 'True if successfully joined'
        },
        'emits': [
            {
                'event': 'player_joined',
    ...
    'leave_game': {
        ...
        'response': {
            'type': 'boolean',
            'description': 'True if successfully left'
        },
        'emits': [
            {
                'event': 'player_left',
    ...
    'end_game': {
        ...
        'response': {
            'type': 'boolean',
            'description': 'True if successfully ended'
        },
        'emits': [
            {
                'event': 'game_ended',
    ...
    'chat_message': {
        ...
        'response': {
            'type': 'boolean',
            'description': 'True if successfully sent'
        },
        'emits': [
            {
                'event': 'chat_message',
...
def get_authenticated_events() -> List[str]:
    ...
    """
    return [
        event for event, docs in EVENTS.items()
