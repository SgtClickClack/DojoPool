...
from .constants import EventTypes, MessageTypes, RoomTypes
...
def sanitize_event(event_type: str, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if event_type == EventTypes.CHAT_MESSAGE:
        ...
        if 'message' in data:
            ...
            data['message'] = re.sub(r'[\u202A-\u202E]', '', data['message'])  # Bidirectional formatting
            data['message'] = re.sub(r'[\u200B-\u200F]', '', data['message'])  # Zero-width characters
