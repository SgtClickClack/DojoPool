...
class RoomPersistence:
    ...
    async def delete_room(
        ...
        try:
            ...
            return format_error_response(
                ErrorCodes.INTERNAL_ERROR,
                "Internal error deleting room data",
                {'error': str(e)}
            )
...
async def start_room_persistence(
    save_interval: int = 60
) -> None:
