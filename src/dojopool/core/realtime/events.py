...
from .constants import EventTypes, ErrorCodes, Permissions
...
def handle_join_tournament(data: Dict[str, Any]) -> None:
    ...
    try:
        ...
        logger.error(
            "Error handling join_tournament",
            exc_info=True,
            extra={'data': data}
        )
        error = format_error_response(
...
def handle_leave_tournament(data: Dict[str, Any]) -> None:
    ...
    try:
        ...
        logger.error(
            "Error handling leave_tournament",
            exc_info=True,
            extra={'data': data}
        )
        error = format_error_response(
...
def handle_start_tournament(data: Dict[str, Any]) -> None:
    ...
    try:
        ...
        logger.error(
            "Error handling start_tournament",
            exc_info=True,
            extra={'data': data}
        )
        error = format_error_response(
