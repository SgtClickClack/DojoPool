...
class RoomMonitor:
    ...
    async def update_stats(self) -> None:
        ...
        try:
            ...
            room_ages = [
                (current_time - r.created_at).total_seconds()
                for r in rooms
            ]
            if room_ages:
                age_stats = {
            ...
            logger.error(
                "Error updating room statistics",
                exc_info=True,
                extra={'error': str(e)}
            )
    ...
    def _update_history(self, current_time: datetime) -> None:
        ...
        for user_id in all_users:
            ...
            user_rooms = [
                r.room_id
                for r in room_manager._rooms.values()
    ...
    def get_user_room_count(self, user_id: str) -> int:
        ...
        """
        return sum(
            1 for room in room_manager._rooms.values()
