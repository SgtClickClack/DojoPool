...
from .constants import ErrorCodes, Permissions
from .utils import format_error_response, verify_token, generate_token
...
class AuthManager:
    ...
    async def record_failed_attempt(
        ...
        async with self._locks[user_id]:
            ...
            recent_attempts = sum(
                1 for attempt in self._failed_attempts[user_id]
