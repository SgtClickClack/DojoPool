...
from .targeting import Operator, TimeWindow
...
class AssignmentManager:
    ...
    def __init__(self):
        ...
        self._assignments: Dict[str, Dict[str, str]] = {}  # user_id -> {experiment_id -> variant_id}
    ...
    def _get_variant_by_rules(
        ...
        matching_rules = [
            rule for rule in self._assignment_rules[experiment_id]
