...
import { PerformanceBudget } from './managers/performance-budget';
import { MonitorOptions, PerformanceMonitor } from './managers/performance-monitor';
import { PerformanceReporter, ReportingOptions } from './managers/performance-reporter';
...
export function initializePerformanceMonitoring(config: PerformanceConfig): PerformanceSystem {
    // Validate configuration
    if (!config.containers.graphs && !config.containers.resources && !config.containers.network) {
