...
export class PerformanceBudgetManager extends BaseManager<PerformanceBudgetManager> {
  ...
  public static override getInstance(
    initialBudget?: PerformanceBudget
  ): PerformanceBudgetManager {
    return (
      BaseManager.getInstance.call(PerformanceBudgetManager) ||
      new PerformanceBudgetManager(initialBudget)
    );
  }
  ...
  public removeViolationListener(
