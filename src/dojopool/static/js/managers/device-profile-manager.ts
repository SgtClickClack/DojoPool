...
export class DeviceProfileManager extends BaseManager<DeviceProfileManager> {
    ...
    private async setupBatteryMonitoring(): Promise<void> {
        try {
            ...
            console.warn('Battery monitoring not available:', error instanceof Error ? error.message : 'Unknown error');
        }
    }
    ...
    private generateProfile(): PerformanceProfile {
        ...
        return {
            ...
            useFloatTextures: capabilities.floatTextureSupport && !capabilities.isLowEndDevice,
