...
describe('PerformanceBudgetManager', () => {
    ...
    describe('Initialization', () => {
        ...
        it('should initialize with custom budget values', () => {
            ...
            expect(customManager['budget']).toEqual(expect.objectContaining(customBudget));
    ...
    describe('Budget Management', () => {
        it('should update budget values', () => {
            ...
            expect(budgetManager['budget']).toEqual(expect.objectContaining(newBudget));
        });
        ...
        it('should throw error for invalid warning threshold', () => {
            expect(() => budgetManager.setWarningThreshold(1.5)).toThrow('Warning threshold must be between 0 and 1');
            expect(() => budgetManager.setWarningThreshold(-0.5)).toThrow('Warning threshold must be between 0 and 1');
        });
    });
    ...
    describe('Performance Checking', () => {
        ...
        it('should calculate utilization percentages', () => {
            ...
            expect(status.utilizationPercentages.workerUtilization).toBeCloseTo(0.63, 2);
