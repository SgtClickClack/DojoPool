...
class FrameProcessorWasm {
    ...
    public static async getInstance(width: number, height: number): Promise<FrameProcessorWasm> {
    ...
    public async processFrame(videoElement: HTMLVideoElement): Promise<ProcessingResult | null> {
