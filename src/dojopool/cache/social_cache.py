...
class SocialCache:
    ...
    @classmethod
    def set_feed(cls, user_id: str, feed_items: List[Dict[str, Any]]):
        """Cache user's feed"""
        key = cls.FEED_KEY.format(user_id)
    ...
    @classmethod
    def set_post(cls, post_id: str, post_data: Dict[str, Any]):
        """Cache post data"""
        key = cls.POST_KEY.format(post_id)
    ...
    @classmethod
    def set_suggestions(cls, user_id: str, suggestions: List[Dict[str, Any]]):
    ...
    @classmethod
    def add_friend(cls, user_id: str, friend_id: str):
    ...
    @classmethod
    def remove_friend(cls, user_id: str, friend_id: str):
    ...
    @classmethod
    def get_mutual_info(cls, user1_id: str, user2_id: str):
    ...
    @classmethod
    def set_mutual_info(
        cls, user1_id: str, user2_id: str, info: Dict[str, Any]
    ) -> None:
    ...
    @classmethod
    def add_to_feed(cls, user_id: str, post_data: Dict[str, Any]):
    ...
    @classmethod
    def remove_from_feed(cls, user_id: str, post_id: str):
    ...
    @classmethod
    def update_feed_post(cls, user_id: str, post_id: str, updates: Dict[str, Any]):
