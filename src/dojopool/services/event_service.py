...
class EventService:
    ...
    def update_event(self, event_id: int, **updates: Any) -> VenueEvent:
    ...
    def register_participant(self, event_id: int, user_id: int) -> VenueEventParticipant:
        ...
        Notification.create(
            ...
            data={"event_id": event_id, "venue_id": event.venue_id},
        )
    ...
    def get_event_participants(
        self, event_id: int, limit: int = 10, offset: int = 0
    ) -> List[Dict[str, Any]]:
        ...
        """
        participants = (
            VenueEventParticipant.query.filter_by(event_id=event_id)
