...
from models.analytics import (
    UserMetrics, GameMetrics, VenueMetrics,
    FeatureUsageMetrics, PerformanceMetrics, AggregatedMetrics
)
...
class AnalyticsService:
    ...
    def get_aggregated_metrics(
        ...
        cache_key = f"{CACHE_PREFIX}aggregated:{metric_type}:{dimension}:{period}:{dimension_id or 'all'}"
        result = cache.get(cache_key)
