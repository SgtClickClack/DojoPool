...
from dojopool.models.venue import Venue, VenueLeaderboard
...
class LeaderboardService:
    ...
    def update_leaderboard(
        ...
        entry = (VenueLeaderboard.query
                .filter_by(venue_id=venue_id, user_id=user_id)
                .first())
    ...
    def get_leaderboard(
        ...
        entries = (query.order_by(desc(VenueLeaderboard.points))
                  .offset(offset)
                  .limit(limit)
                  .all())
    ...
    def get_user_stats(
        ...
        # Get user's rank
        rank = (db.session.query(func.count())
