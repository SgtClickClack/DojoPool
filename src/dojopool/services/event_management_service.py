...
class EventManagementService:
    def create_event(self, data: Dict) -> Dict:
        ...
        try:
            event = Event(
                ...
                registration_deadline=datetime.fromisoformat(data['registration_deadline']) if 'registration_deadline' in data else None,
    ...
    def update_event(self, event_id: str, data: Dict) -> Dict:
        ...
        try:
            ...
            # Update fields
            for field in ['name', 'description', 'event_type', 'max_participants', 'entry_fee', 'prize_pool']:
                if field in data:
