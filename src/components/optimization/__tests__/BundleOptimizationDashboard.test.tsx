...
const mockAnalysis = {
  ...
  chunks: [
    ...
    { name: 'vendor', size: 1024 * 1024 * 3, dependencies: ['react-dom', 'material-ui'] }
  ],
  dependencies: {
    'react': 1024 * 512,
    'react-dom': 1024 * 768,
...
describe('BundleOptimizationDashboard', () => {
  ...
  describe('Initial Render', () => {
    it('should render loading skeleton initially', () => {
      ...
      expect(screen.getByLabelText('Loading bundle optimization dashboard')).toBeInTheDocument();
    });
    ...
    it('should fetch and display bundle analysis data', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('Number of Dependencies: 4')).toBeInTheDocument();
      });
    });
  });
  ...
  describe('Bundle Analysis', () => {
    it('should analyze bundle when path is provided', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByLabelText('Enter bundle path for analysis')).toBeInTheDocument();
      });
