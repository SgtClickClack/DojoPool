...
type TabType = 'violations' | 'rules' | 'strategy' | 'performance' | 'config' | 'metrics';

const AdvancedAIRefereeRuleEnforcementDashboard: React.FC<AdvancedAIRefereeRuleEnforcementDashboardProps> = ({
  matchId,
  playerId,
  onViolationDetected,
  onRuleInterpreted,
  ...
  const filteredViolations = violations.filter(v => 
    (!matchId || v.matchId === matchId) && (!playerId || v.playerId === playerId)
  );
  const filteredStrategyAnalyses = strategyAnalyses.filter(s => 
    (!matchId || s.matchId === matchId) && (!playerId || s.playerId === playerId)
  );
  const filteredPerformanceAssessments = performanceAssessments.filter(p => 
    (!matchId || p.matchId === matchId) && (!playerId || p.playerId === playerId)
  );
  ...
  const getViolationTypeColor = (type: string) => {
    switch (type) {
      case 'foul': return 'text-red-600 bg-red-100';
      case 'warning': return 'text-yellow-600 bg-yellow-100';
      case 'penalty': return 'text-orange-600 bg-orange-100';
      case 'disqualification': return 'text-red-800 bg-red-200';
      default: return 'text-gray-600 bg-gray-100';
    }
  };
  ...
  const tabs = [
    ...
    { id: 'rules', label: 'Rule Interpretations', count: ruleInterpretations.length },
    { id: 'strategy', label: 'Strategy Analysis', count: filteredStrategyAnalyses.length },
    { id: 'performance', label: 'Performance Assessment', count: filteredPerformanceAssessments.length },
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg">
      ...
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-semibold text-gray-900">AI Referee & Rule Enforcement</h2>
            <p className="text-sm text-gray-600">Advanced AI-powered referee system with rule interpretation and enforcement</p>
          </div>
      ...
      <div className="p-6">
        {activeTab === 'violations' && (
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Detect New Violation</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700">Type</label>
                  <select
                    value={newViolationForm.type}
                    onChange={(e) => setNewViolationForm(prev => ({ ...prev, type: e.target.value as any }))}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setNewViolationForm(prev => ({ ...prev, category: e.target.value as any }))}
                    className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setNewViolationForm(prev => ({ ...prev, severity: e.target.value as any }))}
                    className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                  >
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Rule Code</label>
                  <input
                    type="text"
                    value={newViolationForm.ruleCode}
                    onChange={(e) => setNewViolationForm(prev => ({ ...prev, ruleCode: e.target.value }))}
                    className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    placeholder="e.g., 6.3"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewViolationForm(prev => ({ ...prev, violation: e.target.value }))}
                    className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewViolationForm(prev => ({ ...prev, confidence: parseInt(e.target.value) }))}
                    className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    min="0"
                    max="100"
                  />
              ...
              <div className="mt-4">
                ...
                <textarea
                  ...
                  onChange={(e) => setNewViolationForm(prev => ({ ...prev, explanation: e.target.value }))}
                  className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                  rows={3}
              ...
              <div className="mt-4 flex justify-end">
                <button
                  ...
                  disabled={isLoading || !newViolationForm.ruleCode || !newViolationForm.violation}
                  ...
                  <div key={violation.id} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-500">Rule {violation.ruleCode}</span>
                      </div>
                      <div className="text-sm text-gray-500">
                        {new Date(violation.timestamp).toLocaleString()}
                      </div>
                    </div>
                    <h4 className="font-medium text-gray-900 mb-1">{violation.violation}</h4>
                    <p className="text-sm text-gray-600 mb-2">{violation.explanation}</p>
                    <div className="flex items-center justify-between">
                      <div className="text-sm text-gray-500">
                        Player: {violation.playerId} | Match: {violation.matchId} | Confidence: {violation.confidence}%
                      </div>
                      <div className="flex space-x-2">
                        {violation.appealable && violation.status === 'confirmed' && (
                          <button
                            onClick={() => {
                        ...
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                          ...
                          violation.status === 'overturned' ? 'bg-red-100 text-red-800' :
        ...
        {activeTab === 'rules' && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-medium text-gray-900">Rule Interpretations</h3>
              <button
            ...
            <div className="space-y-4">
              {ruleInterpretations.map((interpretation) => (
                <div key={interpretation.id} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium text-gray-900">Rule {interpretation.ruleCode}</h4>
                    <span className="text-sm text-gray-500">
                      {new Date(interpretation.lastUpdated).toLocaleDateString()}
                    </span>
                  </div>
                  <p className="text-sm text-gray-600 mb-2">{interpretation.ruleText}</p>
                  <p className="text-sm text-gray-800 mb-3">{interpretation.interpretation}</p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <h5 className="font-medium text-gray-900 mb-2">Exceptions</h5>
                      <ul className="text-sm text-gray-600 space-y-1">
        ...
        {activeTab === 'strategy' && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-medium text-gray-900">Strategy Analysis</h3>
              <button
                ...
                <div key={analysis.id} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium text-gray-900">
                      {analysis.analysisType.replace('_', ' ').toUpperCase()} Analysis
                    </h4>
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                  ...
                  <div className="mt-3 text-sm text-gray-500">
                    Player: {analysis.playerId} | Match: {analysis.matchId} | Confidence: {analysis.confidence}%
                  </div>
                </div>
              ))}
        ...
        {activeTab === 'performance' && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-medium text-gray-900">Performance Assessment</h3>
              <button
              ...
              {filteredPerformanceAssessments.map((assessment) => (
                <div key={assessment.id} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="font-medium text-gray-900">Performance Assessment</h4>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-900">{assessment.metrics.shotAccuracy}</div>
                      <div className="text-xs text-gray-500">Shot Accuracy</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-900">{assessment.metrics.positionPlay}</div>
                      <div className="text-xs text-gray-500">Position Play</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-900">{assessment.metrics.decisionMaking}</div>
                      <div className="text-xs text-gray-500">Decision Making</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-900">{assessment.metrics.ruleCompliance}</div>
                      <div className="text-xs text-gray-500">Rule Compliance</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-900">{assessment.metrics.sportsmanship}</div>
                ...
                <div>
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) => handleUpdateConfig({ enableRealTimeAnalysis: e.target.checked })}
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="ml-2 text-sm font-medium text-gray-700">Enable Real-time Analysis</span>
                  </label>
                </div>
                <div>
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) => handleUpdateConfig({ enablePredictiveDecisions: e.target.checked })}
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="ml-2 text-sm font-medium text-gray-700">Enable Predictive Decisions</span>
                  </label>
                </div>
                <div>
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) => handleUpdateConfig({ enableRuleLearning: e.target.checked })}
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="ml-2 text-sm font-medium text-gray-700">Enable Rule Learning</span>
                  </label>
                </div>
                <div>
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) => handleUpdateConfig({ enableAppeals: e.target.checked })}
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="ml-2 text-sm font-medium text-gray-700">Enable Appeals</span>
                  </label>
                </div>
              </div>
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleUpdateConfig({ confidenceThreshold: parseInt(e.target.value) })}
                    className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    min="0"
                    max="100"
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleUpdateConfig({ ruleSet: e.target.value as any })}
                    className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleUpdateConfig({ aiModel: e.target.value as any })}
                    className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-blue-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-blue-600">{metrics.totalDecisions}</div>
              ...
              <div className="bg-yellow-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-yellow-600">{metrics.appealRate.toFixed(1)}%</div>
                <div className="text-sm text-yellow-600">Appeal Rate</div>
              </div>
              <div className="bg-purple-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-purple-600">{metrics.analysisAccuracy.toFixed(1)}%</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium text-gray-900 mb-3">Decisions by Type</h4>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-medium text-gray-900">{metrics.responseTime}ms</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Overturned Decisions</span>
                    <span className="text-sm font-medium text-gray-900">{metrics.overturnedDecisions}</span>
                  </div>
                  <div className="flex justify-between items-center">
      ...
      {showAppealModal && selectedViolation && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Appeal Violation</h3>
