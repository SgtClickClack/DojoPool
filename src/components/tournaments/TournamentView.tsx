...
const TournamentView: React.FC<{ tournamentId: string }> = ({ tournamentId }) => {
                    ...
                    <VStack align="start" spacing={2}>
                        ...
                        <HStack spacing={4}>
                            ...
                            <Badge colorScheme={
                                ...
                                tournament.status === 'completed' ? 'gray' : 'orange'
                            }>
                                {tournament.status}
                            </Badge>
                        </HStack>
    ...
    const renderBracket = () => {
        ...
        const rounds = Array.from(
            ...
            (_, i) => tournament.matches.filter(m => m.round === i + 1)
        );
                    ...
                    <VStack key={roundIndex} spacing={4}>
                        ...
                        {roundMatches.map(match => (
                            ...
                            >
                                ...
                                {[match.participant1, match.participant2].map((participant, i) => (
                                    <HStack
                                        key={i}
                                        spacing={3}
                                        py={2}
