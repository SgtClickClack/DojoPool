...
export const TournamentPayment: React.FC<TournamentPaymentProps> = ({
  ...
  const getStatusColor = () => {
    switch (paymentStatus) {
      case 'success': return neonColors.primary;
      case 'error': return neonColors.error;
      case 'processing': return neonColors.info;
    ...
    >
      <CardContent>
        ...
        >
          ...
          <Divider sx={{ my: 2, borderColor: alpha(neonColors.primary, 0.2) }} />
        ...
        <Box display="flex" gap={2} mt={3}>
          ...
          <Button
            ...
            disabled={processing || !isBalanceSufficient || walletLoading || paymentStatus === 'success'}
            sx={{
              flex: 1,
