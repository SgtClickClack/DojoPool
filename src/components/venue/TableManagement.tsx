...
export const TableManagement: React.FC<TableManagementProps> = ({ venueId }) => {
    ...
    <Box>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} sm={6} md={3}>
          ...
          >
            <CardContent sx={{ textAlign: 'center' }}>
              <Typography variant="h3" sx={{ color: neonColors.info, fontWeight: 'bold' }}>
                {tables.length}
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          >
            <CardContent sx={{ textAlign: 'center' }}>
              <Typography variant="h3" sx={{ color: neonColors.secondary, fontWeight: 'bold' }}>
                {occupancyRate}%
              </Typography>
              <Typography variant="body2" sx={{ color: theme.palette.text.secondary }}>
                Occupancy Rate
                ...
                <CardContent>
                  ...
                  {table.status === 'occupied' && table.currentPlayers && (
                    <Box sx={{ mt: 2 }}>
                      ...
                      {table.startTime && (
                        <Typography variant="caption" display="block" sx={{ mt: 1, color: neonColors.warning }}>
                  ...
                  {table.status === 'reserved' && table.reservedBy && (
                    <Box sx={{ mt: 2 }}>
                      ...
                      {table.reservedUntil && (
                        <Typography variant="caption" display="block" sx={{ mt: 1, color: neonColors.warning }}>
                          Until: {new Date(table.reservedUntil).toLocaleTimeString()}
                        </Typography>
                      )}
                    </Box>
                  )}
