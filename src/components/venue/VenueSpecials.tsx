...
const VenueSpecials: React.FC = () => {
  ...
  const [selectedSpecial, setSelectedSpecial] = useState<VenueSpecial | null>(null);
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const [specialsData, usageData, analyticsData, configData] = await Promise.all([
  ...
  const handleCreateSpecial = async () => {
    try {
      await service.createSpecial(newSpecial as Omit<VenueSpecial, 'id' | 'currentUsage' | 'createdAt' | 'updatedAt'>);
  ...
  const getActiveSpecialsCount = () => specials.filter(s => s.status === 'active').length;

  const getTotalUsage = () => usage.length;

  const getTotalDiscount = () => usage.reduce((sum, u) => sum + u.discountApplied, 0);
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card>
            <CardContent>
              ...
              <Typography variant="h4" component="div">
                {specials.length > 0 ? ((getTotalUsage() / specials.length) * 100).toFixed(1) : 0}%
              </Typography>
              <Typography variant="body2" color="textSecondary">
                Usage per special
              </Typography>
                  ...
                  <CardContent>
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) => {
                            service.updateConfig({ autoActivation: e.target.checked });
                            setConfig({ ...config, autoActivation: e.target.checked });
                          }}
                        />
                      }
                    ...
                    <FormControl fullWidth sx={{ mt: 2 }}>
                      ...
                      <Select
                        ...
                        onChange={(e) => {
                          service.updateConfig({ conflictResolution: e.target.value as any });
                          setConfig({ ...config, conflictResolution: e.target.value as any });
                        }}
                      >
                    ...
                    <TextField
                      ...
                      onChange={(e) => {
                        service.updateConfig({ maxActiveSpecials: parseInt(e.target.value) });
                        setConfig({ ...config, maxActiveSpecials: parseInt(e.target.value) });
                      }}
                      sx={{ mt: 2 }}
                    />
                  </CardContent>
          ...
          <Grid container spacing={2} sx={{ mt: 1 }}>
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  label="Type"
                  onChange={(e) => setNewSpecial({ ...newSpecial, type: e.target.value as any })}
                >
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  label="Discount Type"
                  onChange={(e) => setNewSpecial({ ...newSpecial, discountType: e.target.value as any })}
                >
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) => setNewSpecial({ ...newSpecial, startDate: new Date(e.target.value) })}
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) => setNewSpecial({ ...newSpecial, endDate: new Date(e.target.value) })}
                InputLabelProps={{ shrink: true }}
              />
            </Grid>
            <Grid item xs={12} md={6}>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) => setNewSpecial({ ...newSpecial, priority: parseInt(e.target.value) || 1 })}
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) => setNewSpecial({ ...newSpecial, customerGroups: e.target.value as any })}
                >
                  <MenuItem value="all">All Customers</MenuItem>
                  <MenuItem value="members">Members Only</MenuItem>
                  <MenuItem value="new_customers">New Customers</MenuItem>
                  <MenuItem value="returning_customers">Returning Customers</MenuItem>
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={(e) => setNewSpecial({ ...newSpecial, autoActivate: e.target.checked })}
                  />
                }
                label="Auto-activate"
              />
