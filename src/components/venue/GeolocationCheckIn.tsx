      ...
      <Paper
        ...
        sx={{
          ...
          border: `1px solid ${alpha(
            permission === 'granted' ? neonColors.primary : 
            permission === 'denied' ? neonColors.error : 
            neonColors.warning, 
            0.3
          )}`,
          borderRadius: 2,
        ...
        <Zoom in>
          <Box>
            ...
            >
              ...
              <Typography variant="caption" sx={{ color: neonColors.info, fontFamily: 'monospace' }}>
                {location.latitude.toFixed(6)}, {location.longitude.toFixed(6)}
              </Typography>
              
              {accuracy && (
                <Typography variant="caption" display="block" sx={{ color: theme.palette.text.secondary, mt: 1 }}>
            ...
            {!isWithinRange && venueLocation && (
              ...
              >
                You appear to be outside the venue's check-in range. Please move closer to the venue.
              </Alert>
            )}
          </Box>
        </Zoom>
