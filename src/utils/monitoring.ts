...
// Add missing interfaces for ErrorTracker
...
export class GameMetricsMonitor extends EventEmitter {
  ...
  // Getter methods for accessing metric data
  public getFpsData(): MetricData[] {
    return [...this.fpsData];
  }

  public getInputLatencyData(): MetricData[] {
    return [...this.inputLatencyData];
  }

  public getRenderTimeData(): MetricData[] {
    return [...this.renderTimeData];
  }

  public getPhysicsTimeData(): MetricData[] {
    return [...this.physicsTimeData];
  }
...
// Export monitoring instances for external use
export const performanceMonitor = gameMetricsMonitor;
export const locationMonitor = gameMetricsMonitor;
export const systemHealthMonitor = gameMetricsMonitor;
