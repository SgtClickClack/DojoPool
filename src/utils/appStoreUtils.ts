...
export async function generateAppIcons(sourceImagePath: string, outputDir: string): Promise<void> {
  try {
...
export async function generateScreenshot(sourceImagePath: string, outputPath: string, deviceType: 'iphone' | 'ipad'): Promise<void> {
  try {
    const dimensions = deviceType === 'iphone' 
