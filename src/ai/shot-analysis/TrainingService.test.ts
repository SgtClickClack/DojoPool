...
describe('TrainingService', () => {
  ...
  describe('Session Management', () => {
    ...
    test('should throw error when starting session while one is in progress', () => {
      ...
      expect(() => trainingService.startSession(mockExercises)).toThrow('A training session is already in progress');
    });
    ...
    test('should throw error when ending session with none in progress', () => {
      expect(() => trainingService.endSession()).toThrow('No training session in progress');
    });
  });
  ...
  describe('Shot Processing', () => {
    ...
    test('should throw error when processing shot with no session', () => {
      expect(() => trainingService.processShot(mockShot)).toThrow('No training session in progress');
    });
  });
