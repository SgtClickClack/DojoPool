...
describe('ShotAnalysisService', () => {
  ...
  describe('completeShot', () => {
    ...
    it('should throw error when no shot is being tracked', () => {
      expect(() => service.completeShot(true, 0.95)).toThrow('No shot is currently being tracked');
    });
  ...
  describe('analyzeShot', () => {
    ...
    it('should provide appropriate recommendations for low accuracy shots', () => {
      ...
      expect(analysis.recommendations).toContain('Consider reducing power for better accuracy');
      expect(analysis.recommendations).toContain('Focus on fundamental stance and alignment');
    });
    ...
    it('should handle high spin shots', () => {
      ...
      expect(analysis.recommendations).toContain('High side spin may reduce consistency');
    });
