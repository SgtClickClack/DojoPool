                      ...
                      <Grid container spacing={2}>
                        <Grid item xs={12} sm={4} md={3}>
                          ...
                          <Typography variant="h5">
                            {playerPerformance.totalMatches}
                          </Typography>
                        </Grid>
                        <Grid item xs={12} sm={4} md={3}>
                          <Typography variant="subtitle2">Win Rate</Typography>
                          <Typography variant="h5">
                            {(playerPerformance.winRate * 100).toFixed(1)}%
                          </Typography>
                        </Grid>
                        <Grid item xs={12} sm={4} md={3}>
                          <Typography variant="subtitle2">
                        ...
                        <Grid item xs={12} sm={4} md={3}>
                          ...
                          <Typography variant="h5">
                            {playerPerformance.tournamentWins}
                          </Typography>
                        </Grid>
                      </Grid>
                    ) : (
                  ...
                  <CardContent>
                    ...
                    {tournamentHistory.length > 0 ? (
                      <TableContainer component={Paper} sx={{ maxHeight: 400 }}>
                        <Table
                          stickyHeader
                          aria-label="tournament history table"
                        >
                          <TableHead>
                            <TableRow>
