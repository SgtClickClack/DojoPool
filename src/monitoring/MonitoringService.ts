...
import { AlertManager, type Alert } from './alerts/AlertManager';
import { type MonitoringConfig, DEFAULT_MONITORING_CONFIG } from './config';
...
import { type ConsensusProtocol } from '../core/consensus/ConsensusProtocol';
