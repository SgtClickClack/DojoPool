...
import { type NetworkMetricsData } from '../../../collectors/NetworkMetricsCollector';
...
describe('NetworkMetricsPanel', () => {
  ...
  describe('Metric Cards', () => {
    ...
    it('displays bandwidth usage with correct formatting', () => {
      renderPanel();
      const card = screen
        .getAllByText('Bandwidth Usage')[0]
        .closest('.MuiCard-root') as HTMLElement;
    ...
    it('displays error rate with correct formatting', () => {
      ...
      expect(
        within(card!).getByText(new RegExp(`${errorRate}%`))
      ).toBeInTheDocument();
    });
    ...
    it('applies correct color coding based on thresholds', () => {
      ...
      const latencyValue = screen.getByText(/600\.00/)
    ...
    it('applies warning styles when metrics exceed warning thresholds', () => {
      ...
      const latencyValue = screen.getByText(/250\.00/)
        .parentElement as HTMLElement;
  ...
  describe('Charts', () => {
    ...
    it('renders bandwidth usage chart', () => {
      renderPanel();
      const chart = screen
        .getAllByText('Bandwidth Usage')[1]
        .closest('.MuiCard-root') as HTMLElement;
