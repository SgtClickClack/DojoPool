...
import {
  avatar3DService,
  type Avatar3DRequest,
} from '../../services/avatar3DService-Meex';
  ...
  return (
    <Box
      sx={{
        minHeight: '100vh',
        background:
          'linear-gradient(135deg, rgba(10, 10, 10, 0.9) 0%, rgba(26, 26, 26, 0.8) 50%, rgba(10, 10, 10, 0.9) 100%), url("/images/octopus.webp")',
            ...
            <Box sx={{ flex: 1 }}>
              ...
              >
                ...
                >
                  ...
                  <Typography
                    variant="body2"
                    sx={{ color: '#00ff9d', fontStyle: 'italic' }}
                  >
              ...
              >
                ...
                <Box sx={{ width: '100%', height: 400, mb: 3 }}>
                  {model3DUrl ? (
                    ...
                    <Avatar3DPreview
                      image={
                        typeof previewUrl === 'string' ? previewUrl : undefined
                      }
                      prompt={customPrompt}
                    />
                  )}
