        ...
        <CardContent>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              ...
              >
                <SportsPool color="info" sx={{ fontSize: 40 }} />
                <Typography variant="h6" sx={{ mt: 1 }}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              ...
              >
                <VolumeUp color={voiceEnabled ? 'primary' : 'error'} sx={{ fontSize: 40 }} />
                <Typography variant="h6" sx={{ mt: 1 }}>
                  {voiceEnabled ? 'On' : 'Off'}
                </Typography>
                <Typography variant="body2" color="text.secondary">
          ...
          <List>
            {participants.map((participant) => (
              <ListItem
                ...
                secondaryAction={
                  <ListItemSecondaryAction>
                    <IconButton edge="end" onClick={() => setSelectedParticipant(participant.userId)}>
                      <Person />
                    </IconButton>
                  </ListItemSecondaryAction>
                }
