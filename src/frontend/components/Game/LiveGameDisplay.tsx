...
import { BackendGameDetails } from '../../contexts/SocketContext'; // Adjust path if context moved
...
const LiveGameDisplay: React.FC<LiveGameDisplayProps> = ({ gameDetails }) => {
  ...
  return (
    <Paper elevation={3} sx={{ padding: 2 }}>
      <Typography variant="h6" gutterBottom>Live Game Info: {id}</Typography>
        ...
        */}
        ...
        <Grid item xs={12}>
          <Box>
            ...
            <Typography variant="subtitle1">Type: {game_type} ({game_mode})</Typography>
            ...
            <Box mt={2}>
              ...
              <Typography>{player1} vs {player2}</Typography>
