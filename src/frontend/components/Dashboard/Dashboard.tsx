...
import AnimatedAvatar3D from '@/components/Avatar/AnimatedAvatar3D';
...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      'avatarCreated',
      handleAvatarCreated as EventListener
    );
      ...
      <Box sx={{ py: 6 }}>
        ...
        {showWelcomeBack && (
          ...
          >
            ...
            >
              Your avatar has been created successfully. Ready to dominate the
              pool?
            </Typography>
          </Box>
        )}
          ...
          <Box sx={{ flex: 1 }}>
            <Paper
              ...
              sx={{
                p: 3,
                background:
                  'linear-gradient(135deg, #181818 60%, #ffb300 100%)',
                ...
                '&:hover': {
                  ...
                  boxShadow:
                    '0 0 40px #ffb300, 0 0 60px rgba(255, 179, 0, 0.5)',
                },
              }}
            ...
            <Box key={index} sx={{ flex: 1 }}>
              <Paper
                ...
                sx={{
                  ...
                  borderRadius: 3,
                  boxShadow:
                    '0 0 30px #00a8ff, 0 0 50px rgba(0, 168, 255, 0.3)',
                  cursor: 'pointer',
                  transition: 'all 0.3s ease',
                  '&:hover': {
                    transform: 'translateY(-5px)',
                    boxShadow:
                      '0 0 40px #00a8ff, 0 0 60px rgba(0, 168, 255, 0.5)',
                  },
                }}
        ...
        >
          <Box sx={{ flex: 1 }}>
            ...
            >
              <Typography
                variant="h5"
                sx={{ color: '#00a8ff', mb: 2, fontFamily: 'Orbitron' }}
              >
                Wallet Balance
              </Typography>
              <Typography
          ...
          <Box sx={{ flex: 1 }}>
            <Paper
              sx={{
                p: 3,
                background:
                  'linear-gradient(135deg, #181818 60%, #f7b731 100%)',
            ...
            >
              <Typography
                variant="h5"
                sx={{ color: '#f7b731', mb: 2, fontFamily: 'Orbitron' }}
              >
                Rewards
              </Typography>
              <Typography
          ...
          <Box sx={{ flex: 1 }}>
            <Paper
              sx={{
                p: 3,
                background:
                  'linear-gradient(135deg, #181818 60%, #ff6b6b 100%)',
            ...
            >
              <Typography
                variant="h5"
                sx={{ color: '#ff6b6b', mb: 2, fontFamily: 'Orbitron' }}
              >
                Games Won
              </Typography>
              <Typography
