...
class ToastService {
  ...
  public show(config: Partial<ToastConfig>): void {
    ...
    const fullConfig: ToastConfig = {
      ...
      ...config,
      id,
      message: config.message, // Ensure message is always defined
      type: config.type || this.defaultConfig.type || 'info', // Ensure type is always defined
    };

    // Track toast display in analytics
    analyticsService.trackEvent('toast_displayed', {
      toastId: id,
  ...
  public dismiss(id: string): void {
    ...
    analyticsService.trackEvent('toast_dismissed', {
      toastId: id,
