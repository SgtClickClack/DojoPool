...
class SocialService:
    ...
    def generate_share_links(self, content_type: str, content_id: str, 
                           title: str, description: Optional[str] = None) -> Dict[str, str]:
        ...
        for platform, template in self.share_templates.items():
            share_links[platform] = template.format(
                text=encoded_text,
                url=encoded_url
            )
    ...
    def generate_achievement_share(self, achievement_id: str, name: str, description: str) -> Dict[str, str]:
    ...
    def generate_tournament_share(self, tournament_id: str, name: str, 
                                position: Optional[str] = None) -> Dict[str, str]:
        ...
        return self.generate_share_links(
            ...
            content_id=tournament_id,
            title=title
        )
    
    def generate_match_share(self, match_id: str, opponent_name: str, 
                           score: str, won: bool) -> Dict[str, str]:
