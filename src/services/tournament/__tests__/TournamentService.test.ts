...
describe('TournamentService', () => {
  ...
  describe('addParticipant', () => {
    it('should add a participant to the tournament', async () => {
      ...
      const result = await tournamentService.addParticipant('tournament-1', 'player-1');
  ...
  describe('removeParticipant', () => {
    it('should remove a participant from the tournament', async () => {
      ...
      const result = await tournamentService.removeParticipant('tournament-1', 'player-1');
  ...
  describe('addMatch', () => {
    it('should add a match to the tournament', async () => {
      ...
      const result = await tournamentService.addMatch('tournament-1', 'match-1');
  ...
  describe('updateTournamentResults', () => {
    it('should update tournament results', async () => {
      ...
      const result = await tournamentService.updateTournamentResults('tournament-1', {
        winnerId: 'player-1',
        finalStandings: ['player-1', 'player-2'],
      });
