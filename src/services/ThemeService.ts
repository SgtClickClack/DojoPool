...
const stateService = {
  ...
  getState: (selector: (state: any) => any) => ({ ui: { theme: 'system' } }),
};
...
class ThemeService {
  ...
  private initialize(): void {
    ...
    analyticsService.trackEvent('theme_service_initialized', {
  ...
  private applyTheme(theme: Theme): void {
    ...
    // Track theme change
    analyticsService.trackEvent('theme_changed', {
      themeId: theme.id,
      isDark: theme.isDark,
      timestamp: new Date().toISOString(),
    });
  ...
  public registerTheme(theme: Theme): void {
    ...
    analyticsService.trackEvent('theme_registered', {
      themeId: theme.id,
  ...
  public setAutoDetectSystemTheme(enabled: boolean): void {
    ...
    analyticsService.trackEvent('theme_auto_detect_changed', {
      enabled,
      timestamp: new Date().toISOString(),
    });
  }
