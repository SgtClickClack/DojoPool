...
export const redis = new Redis({
  host: process.env.REDIS_URL ? parse(process.env.REDIS_URL).hostname || 'localhost' : 'localhost',
  port: process.env.REDIS_URL ? parseInt(parse(process.env.REDIS_URL).port || '6379', 10) : 6379,
