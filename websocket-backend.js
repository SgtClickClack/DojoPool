      ...
      JSON.stringify({
        ...
        upcoming: [
          ...
          },
          {
            ...
            startTime: '2025-07-26T20:00:00Z',
            participants: 16,
          },
        ],
      })
      ...
      JSON.stringify({
        currentMatch: {
          ...
          commentary: [
            {
              time: '00:15',
              text: 'RyuKlaw sets up for a classic corner shot...',
              type: 'play',
            },
            {
              time: '00:23',
              text: 'The AI Umpire approves the shot angle!',
              type: 'referee',
            },
            {
              time: '00:31',
              text: 'What a spectacular bank shot! The Pool Gods are impressed!',
              type: 'commentary',
            },
          ],
        },
        recentHighlights: [
          {
            ...
            player: 'RyuKlaw',
            venue: 'Jade Tiger',
            timestamp: '2025-07-22T21:15:00Z',
          },
          {
            id: 'h2',
...
server.listen(PORT, () => {
  console.log(
    `🚀 DojoPool Real-Time Backend running on http://localhost:${PORT}`
  );
  ...
  console.log(
    `⚙️ Features: realTime, multiplayer, tournaments, clanWars, aiCommentary`
  );
});
