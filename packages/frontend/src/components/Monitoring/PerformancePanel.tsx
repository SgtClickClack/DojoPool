...
import { PerformanceMetrics, MetricsSnapshot } from '../../types/monitoring';
...
export const PerformancePanel: React.FC = () => {
    ...
    const [historicalData, setHistoricalData] = useState<MetricsSnapshot | null>(null);
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <MetricCard 
                        ...
                        value={(currentMetrics.networkSent + currentMetrics.networkReceived) / 1024}
                        unit="MB/s" 
                    />
                </Grid>
            </Grid>
                ...
                <Card>
                    <CardContent>
                        <ResponsiveContainer width="100%" height={400}>
                            <LineChart data={historicalData.historical.cpuUsage}>
