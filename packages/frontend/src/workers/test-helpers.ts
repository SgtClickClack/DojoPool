 ...
 */
export async function createTestFrame(width: number, height: number): Promise<ImageData> {
 ...
 */
export function sendFrameToWorker(worker: Worker, frame: ImageData): Promise<any> {
 ...
 */
export function calculateStats(data: number[]): { mean: number; stdDev: number } {
