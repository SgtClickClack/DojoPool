describe('Achievements and Rankings', () => {
  ...
  describe('Achievement Unlocking', () => {
    ...
    it('should track progress towards Streak Master achievement', () => {
      cy.createGame(users.validUser.id, users.existingUser.id).then((gameId) => {
        ...
        cy.findByText('Streak Master').parent().within(() => {
  ...
  describe('Achievement Progress Tracking', () => {
    it('should persist progress across sessions', () => {
      ...
      cy.visit('/achievements');
      const initialProgress = cy.findByTestId('venue-master-progress').invoke('text');
      ...
      cy.reload();
      cy.findByTestId('venue-master-progress').invoke('text')
  ...
  describe('Ranking System', () => {
    it('should calculate correct rank based on achievement points', () => {
      ...
      // Get current points
      cy.findByTestId('achievement-points').invoke('text').then((points) => {
        const currentPoints = parseInt(points);
        
        // Find expected rank
        const rank = achievements.milestones.ranks.find(r => 
  ...
  describe('Achievement Statistics', () => {
    it('should show achievement rarity percentages', () => {
      ...
      cy.findByText('Perfect Game').parent().within(() => {
