...
export const api = {
  training: {
    getRecommendations: (): Promise<AxiosResponse<any>> =>
      apiClient.get('/training/recommendations'),
    submitProgress: (data: any): Promise<AxiosResponse<any>> =>
      apiClient.post('/training/progress', data),
  },
  gameAnalysis: {
    analyze: (data: any): Promise<AxiosResponse<any>> =>
      apiClient.post('/game-analysis', data),
    getHistory: (): Promise<AxiosResponse<any>> =>
      apiClient.get('/game-analysis/history'),
  },
  tournaments: {
    list: (): Promise<AxiosResponse<any>> => apiClient.get('/tournaments'),
    join: (id: string | number): Promise<AxiosResponse<any>> =>
      apiClient.post(`/tournaments/${id}/join`),
    getDetails: (id: string | number): Promise<AxiosResponse<any>> =>
