...
if (currentApp) {
  ...
  console.error(
    'Firebase app is not initialized. Performance monitoring will be disabled.'
  );
}
...
export const logCustomEvent = (
  ...
  if (firebaseAnalytics) {
    ...
    console.warn(
      `Analytics not initialized. Event not logged: ${eventName}`,
      eventParams
    );
  }
};
...
export const logPageView = (pagePath: string, pageTitle: string): void => {
  if (firebaseAnalytics) {
    ...
    console.warn(
      `Analytics not initialized. Page view not logged: ${pagePath}`
    );
  }
};
...
export const logUserAction = (
  ...
  if (firebaseAnalytics) {
    ...
    console.warn(
      `Analytics not initialized. User action not logged: ${actionName}`,
      actionParams
    );
  }
};
...
export const logErrorToAnalytics = (
  ...
  if (firebaseAnalytics) {
    ...
    console.warn(
      'Analytics not initialized. Error not logged:',
      error,
      context
    );
  }
