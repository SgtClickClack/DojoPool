...
JWT_ACCESS_TOKEN_LIFETIME = int(config('JWT_ACCESS_TOKEN_LIFETIME', default=30))  # minutes
JWT_REFRESH_TOKEN_LIFETIME = int(config('JWT_REFRESH_TOKEN_LIFETIME', default=7))  # days
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'backend.auth.jwt.JWTAuthentication',
