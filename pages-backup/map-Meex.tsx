import { AccessTime, Business, LocationOn, Star } from '@mui/icons-material';
import {
  Box,
  Card,
  CardContent,
...
import WorldHub from '../src/components/world/WorldHub';
            ...
            {nearbyVenues.map((venue) => (
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                  <LocationOn
                    sx={{ color: venue.color, mr: 1, fontSize: 24 }}
                  />
                  <Typography
                    variant="h6"
                    sx={{
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  ...
                  <AccessTime
                    sx={{ color: '#00a8ff', fontSize: 16, mr: 0.5 }}
                  />
                ...
                >
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <Business
                      sx={{ color: '#00ff9d', fontSize: 16, mr: 0.5 }}
                    />
