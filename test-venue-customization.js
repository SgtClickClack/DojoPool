async function testVenueCustomization() {
  try {
    ...
    const previewResponse = await fetch('http://localhost:8080/api/venue-customization/preview', {
      method: 'POST',
      headers: {
    ...
    if (previewResponse.ok) {
      ...
      console.log('Generated customization:', JSON.stringify(previewData.customization, null, 2));
    } else {
