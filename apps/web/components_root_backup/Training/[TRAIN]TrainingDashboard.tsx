...
const api = {
  get: async (url: string): Promise<any> => {
    if (url.includes('recommend')) {
      return {
        data: {
          program: { id: 1, name: 'Beginner Pool', description: 'Basic training program', difficulty: 'beginner', duration_weeks: 4 },
          match_score: 0.8,
          reasons: ['Good for beginners', 'Focuses on fundamentals']
        }
      };
      ...
      return {
        data: {
          progress: [
            { program: 'Beginner Pool', exercise: 'Basic Shot', completion_date: '2024-01-15', performance_metrics: { accuracy: 0.8, speed: 0.7 }, notes: 'Good progress' }
          ]
        }
      };
    }
