...
const TournamentRewards: React.FC<TournamentRewardsProps> = ({
  ...
  const rewards = {
    availableRewards: [
      {
        ...
        value: 1000,
        rarity: 'legendary',
        description: 'A prestigious trophy for the winner',
        requiredScore: 1000,
      ...
      },
      {
        ...
        value: 500,
        rarity: 'epic',
        description: 'A silver medal for the runner-up',
        requiredScore: 800,
        expiryDate: '2024-12-31',
        claimed: false,
      },
    ...
    claimedRewards: [
      {
        ...
        value: 100,
        rarity: 'common',
        description: 'A badge for participating in the tournament',
        requiredScore: 100,
        expiryDate: '2024-12-31',
        claimed: true,
    ...
    userScore: 1200,
    leaderboard: [
      { userId: '1', username: 'Player1', score: 1500, rank: 1, totalValue: 2000, rewards: [{ id: '1', name: 'Trophy' }], teamName: 'Team Alpha' },
      { userId: '2', username: 'Player2', score: 1200, rank: 2, totalValue: 1500, rewards: [{ id: '2', name: 'Medal' }], teamName: 'Team Beta' },
      { userId: '3', username: 'Player3', score: 1000, rank: 3, totalValue: 1000, rewards: [{ id: '3', name: 'Badge' }], teamName: 'Team Gamma' },
    ],
  };
  const claimReward = async (id: string) => {};
  const rewardsLoading = false;
  const rewardsError = null;
