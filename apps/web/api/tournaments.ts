...
export const getTournamentMatches = async (id: string, round?: number) => {
...
export const updateMatch = async (id: number, data: UpdateMatchData) => {
...
export const getTournamentStats = async (id: string) => {
