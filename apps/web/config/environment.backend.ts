...
export const env = {
  ...
  ENCRYPTION_KEY:
    process.env.ENCRYPTION_KEY || 'dojopool-encryption-key-32-chars',
  ...
  GAME_SETTINGS: {
    DEFAULT_MATCH_DURATION: parseInt(
      process.env.DEFAULT_MATCH_DURATION || '1800'
    ), // 30 minutes
    ...
    TERRITORY_CONTROL_DURATION: parseInt(
      process.env.TERRITORY_CONTROL_DURATION || '86400'
    ), // 24 hours
  ...
  SECURITY: {
    ...
    ACCOUNT_LOCKOUT_DURATION: parseInt(
