...
export const optimizeImage = async (
  ...
  const params = new URLSearchParams({
    url: src,
    quality: cdnConfig.imageOptimizationParams.quality.toString(),
    format: cdnConfig.imageOptimizationParams.format,
    width: cdnConfig.imageOptimizationParams.width.toString(),
