  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4 }}>
      ...
      <Box sx={{ mb: 4, p: 2, bgcolor: 'background.paper', borderRadius: 2 }}>
        ...
        <Typography
          variant="body1"
          color={backendStatus === 'Connected' ? 'success.main' : 'error.main'}
        >
...
const Navigation = () => (
  <AppBar position="static">
    <Toolbar>
      ...
      <Button color="inherit" component={Link} to="/game-mechanics">
        Game Mechanics
      </Button>
      <Button color="inherit" component={Link} to="/tournaments">
        Tournaments
      </Button>
      <Button color="inherit" component={Link} to="/clan-wars">
        Clan Wars
      </Button>
      <Button color="inherit" component={Link} to="/ai-commentary">
        AI Commentary
      </Button>
    </Toolbar>
  </AppBar>
