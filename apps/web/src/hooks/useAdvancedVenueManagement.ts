...
export const useAdvancedVenueManagement = () => {
  ...
  const updateConfig = useCallback(
    async (newConfig: Partial<VenueConfig>) => {
      try {
        setIsLoading(true);
        const response = await fetch('/api/advanced-venue-management/config', {
          method: 'PUT',
  ...
  const getAllPerformances = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        '/api/advanced-venue-management/performances'
      );
      const data = await response.json();
  ...
  const getVenuePerformance = useCallback(async (venueId: string) => {
    try {
      setIsLoading(true);
      const response = await fetch(
        `/api/advanced-venue-management/performances/${venueId}`
      );
      const data = await response.json();
  ...
  const updateVenuePerformance = useCallback(
    async (venueId: string, performanceData: any) => {
      try {
        setIsLoading(true);
        const response = await fetch(
          `/api/advanced-venue-management/performances/${venueId}`,
  ...
  const getTopPerformingVenues = useCallback(async (limit: number = 10) => {
    try {
      setIsLoading(true);
      const response = await fetch(
        `/api/advanced-venue-management/performances/top/${limit}`
      );
      const data = await response.json();
  ...
  // Venue Analytics
  const generateVenueAnalytics = useCallback(
    async (
      venueId: string,
      ...
      try {
        setIsLoading(true);
        const response = await fetch(
          `/api/advanced-venue-management/analytics/${venueId}`,
          {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
  ...
  // Table Performance
  const updateTablePerformance = useCallback(
    async (tableId: string, venueId: string, performanceData: any) => {
      try {
        setIsLoading(true);
        const response = await fetch(
          `/api/advanced-venue-management/tables/${tableId}`,
          {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
  ...
  const getTablePerformances = useCallback(async (venueId: string) => {
    try {
      setIsLoading(true);
      const response = await fetch(
        `/api/advanced-venue-management/tables/${venueId}`
      );
      const data = await response.json();
  ...
  const addMaintenanceRecord = useCallback(
    async (
      ...
      try {
        setIsLoading(true);
        const response = await fetch(
          `/api/advanced-venue-management/tables/${tableId}/maintenance`,
          {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
  ...
  // Player Engagement
  const updatePlayerEngagement = useCallback(
    async (venueId: string, playerId: string, engagementData: any) => {
      try {
        setIsLoading(true);
        const response = await fetch(
          `/api/advanced-venue-management/engagement/${venueId}/${playerId}`,
          {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
  ...
  const getPlayerEngagements = useCallback(async (venueId: string) => {
    try {
      setIsLoading(true);
      const response = await fetch(
        `/api/advanced-venue-management/engagement/${venueId}`
      );
      const data = await response.json();
  ...
  const generateRevenueAnalytics = useCallback(
    async (venueId: string, period: string) => {
      try {
        setIsLoading(true);
        const response = await fetch(
          `/api/advanced-venue-management/revenue/${venueId}`,
          {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
  ...
  const generateVenueOptimization = useCallback(async (venueId: string) => {
    try {
      setIsLoading(true);
      const response = await fetch(
        `/api/advanced-venue-management/optimization/${venueId}`,
        {
          method: 'POST',
        }
      );
