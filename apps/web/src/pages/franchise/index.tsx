    ...
    <CyberpunkContainer maxWidth={false}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ color: 'text.secondary', mb: 3 }}>
          Multi-venue operations, international scaling, and franchise
          management system
        </Typography>
      ...
      <Box sx={{ mb: 4 }}>
        <CyberpunkPaper sx={{ p: 3 }}>
          ...
          <Typography variant="body2" sx={{ color: 'text.secondary', mb: 2 }}>
            Our advanced franchise management system provides comprehensive
            tools for scaling operations globally, managing multi-venue
            networks, and optimizing franchise performance.
          </Typography>
          <Typography variant="body2" sx={{ color: 'text.secondary' }}>
            Features: Global Network Management • Multi-Venue Operations •
            International Scaling • Franchise Performance Analytics • Compliance
