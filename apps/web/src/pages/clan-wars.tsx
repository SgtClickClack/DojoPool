...
const sampleClans = [
  ...
  },
  {
    ...
    warLosses: 20,
    members: [
      { id: '10', name: 'ShadowAlpha', role: 'leader', level: 20, avatarUrl: undefined },
      { id: '11', name: 'NightStalker', role: 'officer', level: 17, avatarUrl: undefined },
      { id: '12', name: 'StealthKiller', role: 'member', level: 16, avatarUrl: undefined },
    ],
    isMember: false,
  },
  {
    ...
    warLosses: 15,
    members: [
      { id: '13', name: 'PhoenixRise', role: 'leader', level: 18, avatarUrl: undefined },
      { id: '14', name: 'GoldenWing', role: 'officer', level: 16, avatarUrl: undefined },
      { id: '15', name: 'FireBird', role: 'member', level: 15, avatarUrl: undefined },
    ],
    isMember: false,
  },
  {
    ...
    warLosses: 18,
    members: [
      { id: '16', name: 'SerpentKing', role: 'leader', level: 21, avatarUrl: undefined },
      { id: '17', name: 'SilverTongue', role: 'officer', level: 18, avatarUrl: undefined },
      { id: '18', name: 'VenomStrike', role: 'member', level: 17, avatarUrl: undefined },
    ],
    isMember: false,
  },
];
