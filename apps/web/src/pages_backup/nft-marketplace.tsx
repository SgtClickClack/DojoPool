          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-blue-100">
                Trade, collect, and earn unique NFTs from your pool gaming
                achievements
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Earn exclusive NFTs by winning tournaments and achieving
                  milestones in your pool gaming journey.
                </p>
              </div>
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Unlock rare NFTs through exceptional gameplay, shot accuracy,
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Trade your NFTs across multiple blockchains with seamless
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Play pool games and participate in tournaments to earn
                  achievements.
                </p>
              </div>
              <div className="text-center">
        ...
        <div className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">
              Join the DojoPool community and start earning unique digital
              collectibles today.
            </p>
