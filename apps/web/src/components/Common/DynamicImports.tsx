...
export const DynamicMapboxMap = dynamic(
  () => import('@/components/world/MapboxWorldHubMap'),
  {
    ssr: false,
    loading: () => (
      <div className="flex items-center justify-center h-64">
...
// Note: recharts is a library, not a component, so it should be imported normally
...
// Note: framer-motion is a library, not a component, so it should be imported normally
...
// Heavy UI components
export const DynamicCMSDashboard = dynamic(
  () =>
    import('@/components/CMS').then((mod) => ({ default: mod.CMSDashboard })),
  {
    ssr: false,
    loading: () => (
      <div className="flex items-center justify-center h-64">
...
export const DynamicPerformanceDashboard = dynamic(
  () =>
    import('@/components/Dashboard/PerformanceDashboard').then((mod) => ({
