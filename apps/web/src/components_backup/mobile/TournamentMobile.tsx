                  ...
                  <Box>
                    ...
                    >
                      ...
                      <Button
                        ...
                        disabled={syncing}
                        startIcon={
                          syncing ? <CircularProgress size={16} /> : <Sync />
                        }
                        sx={{
                          bgcolor: '#00ff9d',
                          color: '#000',
                  ...
                  <Box>
                    ...
                    <Box sx={{ mb: 2 }}>
                      ...
                      <LinearProgress
                        variant="determinate"
                        value={Math.min(
                          ((offlineData.tournaments.length +
                            offlineData.matches.length) /
                            100) *
                            100,
                          100
                        )}
                      ...
                      <ListItem key={action.id} sx={{ px: 0 }}>
                        <ListItemText
                          ...
                          secondary={
                            ...
                            >
                              {formatDate(action.timestamp)} • Retries:{' '}
                              {action.retryCount}
                            </Typography>
                          }
                        />
                ...
                {deviceInfo && (
                  <Box>
                    ...
                    <Grid container spacing={1}>
                      {Object.entries(deviceInfo.capabilities).map(
                        ([key, value]) => (
                ...
                <List>
                  ...
                  <ListItem sx={{ px: 0 }}>
                    ...
                    <ListItemText
                      ...
                      secondary={
                        config?.enablePushNotifications ? 'Enabled' : 'Disabled'
                      }
                      sx={{ color: '#ffffff' }}
                    />
                  </ListItem>
