...
const TournamentPerformance: React.FC = () => {
              ...
              <>
                <Box sx={{ mb: 3 }}>
                  ...
                  >
                    ...
                    <Typography
                      variant="body2"
                      sx={{ color: getPerformanceColor(metrics.cpuUsage, 80) }}
                    >
                ...
                <Box sx={{ mb: 3 }}>
                  ...
                  >
                    ...
                    <Typography
                      variant="body2"
                      sx={{
                        color: getPerformanceColor(metrics.networkLatency, 200),
                      }}
                    >
                ...
                <Box sx={{ mb: 3 }}>
                  ...
                  >
                    ...
                    <Typography
                      variant="body2"
                      sx={{
                        color: getPerformanceColor(metrics.responseTime, 300),
                      }}
                    >
                ...
                <Grid container spacing={2}>
                  <Grid item xs={6}>
                    <Box sx={{ textAlign: 'center' }}>
                      <Typography
                        variant="h4"
                        sx={{ color: '#00ff9d', fontWeight: 700 }}
                      >
                  ...
                  <Grid item xs={6}>
                    <Box sx={{ textAlign: 'center' }}>
                      <Typography
                        variant="h4"
                        sx={{ color: '#00a8ff', fontWeight: 700 }}
                      >
          ...
          <CardContent>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <Button
                ...
                sx={{
                  background:
                    'linear-gradient(45deg, #feca57 0%, #ff9ff3 100%)',
                  color: '#000',
                  fontFamily: 'Orbitron, monospace',
                  fontWeight: 600,
                  '&:hover': {
                    background:
                      'linear-gradient(45deg, #ff9ff3 0%, #feca57 100%)',
                  },
                }}
              >
                Configure Cache
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              ...
              <Slider
                ...
                onChange={(_, value) =>
                  setConfig({ ...config, maxCacheSize: value as number })
                }
                min={100}
                max={5000}
                step={100}
              ...
              <Slider
                ...
                onChange={(_, value) =>
                  setConfig({ ...config, cacheTtl: (value as number) * 1000 })
                }
                min={60}
                max={1800}
                step={60}
              ...
              <Slider
                ...
                onChange={(_, value) =>
                  setConfig({
                    ...config,
                    maxMemoryUsage: (value as number) / 100,
                  })
                }
                min={50}
                max={95}
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={(e) =>
                      setConfig({ ...config, preloadEnabled: e.target.checked })
                    }
                    sx={{
                      '& .MuiSwitch-switchBase.Mui-checked': {
                        color: '#00ff9d',
  ...
  return (
    <Box sx={{ p: 4 }}>
      ...
      >
        <DialogTitle
          sx={{ color: '#00ff9d', fontFamily: 'Orbitron, monospace' }}
        >
              ...
              <Grid item xs={12} md={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    setTempConfig({
                      ...tempConfig,
                      cacheTtl: parseInt(e.target.value) * 1000,
                    })
                  }
                  fullWidth
                  sx={{
