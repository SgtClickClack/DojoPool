    ...
    <Layout>
      <Box
        sx={{
          p: { xs: 2, md: 4 },
          background:
            'linear-gradient(135deg, rgba(0,255,157,0.05) 0%, rgba(0,168,255,0.05) 100%)',
          minHeight: '100vh',
        }}
      >
        {/* Header */}
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <AccountBalanceWallet
                      sx={{ color: '#00ff9d', mr: 2, fontSize: 28 }}
                    />
                    <Typography
                      variant="h6"
                      sx={{
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    <EmojiEvents
                      sx={{ color: '#00a8ff', mr: 2, fontSize: 28 }}
                    />
                    <Typography
                      variant="h6"
                      sx={{
                ...
                <Box>
                  {recentActivity.map((activity, index) => (
                    <Box key={activity.id}>
                      ...
                      >
                        <Avatar
                          sx={{ bgcolor: '#00ff9d20', color: '#00ff9d', mr: 2 }}
                        >
                          {activity.icon}
                        </Avatar>
                        <Box sx={{ flexGrow: 1 }}>
