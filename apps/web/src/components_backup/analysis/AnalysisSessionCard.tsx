...
import { type AdvancedAnalysisSession } from '../../types/analysis';
...
const AnalysisSessionCard: React.FC<AnalysisSessionCardProps> = ({
  session,
  onStartAnalysis,
}) => {
  return (
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={4}>
              <Box textAlign="center">
                ...
                <Typography variant="h6" color="#45b7d1">
                  {session.physicalScore}
                </Typography>
              </Box>
            </Grid>
          </Grid>
