...
const TournamentPredictionComponent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleTournamentPredictionGenerated = (
    ...
    service.on(
      'tournamentPredictionGenerated',
      handleTournamentPredictionGenerated
    );
    ...
    <Box>
      ...
      >
        ...
        <Button
          variant="outlined"
          onClick={() =>
            service.generatePlayerPrediction('player1', 'tournament_1')
          }
            ...
            >
              <CardContent>
                ...
                <Box sx={{ mt: 2 }}>
                  <Typography
                    variant="body2"
                    sx={{ color: '#00a8ff', fontWeight: 600, mb: 1 }}
                  >
                    Insights:
                  </Typography>
    ...
    <Box>
      ...
      >
        ...
        <Button
          variant="outlined"
          onClick={() =>
            service.generateMatchPrediction('match_2', 'player1', 'player2')
          }
          sx={{ color: '#00ff9d', borderColor: '#00ff9d' }}
        >
          Generate New
            ...
            >
              <CardContent>
                ...
                >
                  <Typography
                    variant="h6"
                    sx={{ color: '#00a8ff', fontWeight: 600 }}
                  >
              ...
              <Grid item xs={12} md={6}>
                ...
                {prediction.darkHorses.map((horse, index) => (
                  <Typography
                    ...
                    sx={{ color: '#ccc', mb: 0.5 }}
                  >
                    • {horse.playerName} - {horse.upsetPotential.toFixed(1)}%
                    upset potential
                  </Typography>
                ))}
              </Grid>
  ...
  const renderMetrics = () => (
    <Box>
      <Typography
        variant="h6"
        sx={{ ...neonTextStyle, color: '#00ff9d', mb: 2 }}
      >
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                ...
                {Object.entries(metrics.modelPerformance).map(
                  ([model, performance]) => (
                    <Box key={model} sx={{ mb: 2 }}>
                      <Typography
                        variant="body2"
                        sx={{ color: '#ffcc00', mb: 1 }}
                      >
                        {model
                          .replace(/([A-Z])/g, ' $1')
                          .replace(/^./, (str) => str.toUpperCase())}
  ...
  const renderSettings = () => (
    <Box>
      <Typography
        variant="h6"
        sx={{ ...neonTextStyle, color: '#ffcc00', mb: 2 }}
      >
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            <CardContent>
              ...
              {config &&
                Object.entries(config.modelWeights).map(([factor, weight]) => (
      ...
      <Paper sx={cyberpunkPaper}>
        ...
        >
          ...
          <Typography variant="body2">
            This AI prediction system is designed for{' '}
            <strong>
              analytics, entertainment, and performance analysis purposes only
            </strong>
            . It is <strong>NOT intended for betting or gambling</strong>. All
            predictions are for fun and educational purposes to enhance the
            tournament experience and provide insights into player performance
            and match dynamics.
          </Typography>
        </Alert>
