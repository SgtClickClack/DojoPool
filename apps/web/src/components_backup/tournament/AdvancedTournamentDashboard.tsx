...
import {
  ...
  type AdvancedTournamentConfig,
  TournamentAnalytics,
  TournamentInsights,
  TournamentBracket,
  type BracketNode,
} from '../../hooks/useAdvancedTournament';
...
export const AdvancedTournamentDashboard: React.FC = () => {
  ...
  const [tournamentConfig, setTournamentConfig] = useState<
    Partial<AdvancedTournamentConfig>
  >({
    name: '',
                      ...
                      <ListItemText
                        ...
                        secondary={
                          <Chip
                            ...
                            color={
                              getStatusColor(currentTournament.status) as any
                            }
                            size="small"
                          />
                        }
                    ...
                    <List dense>
                      ...
                      <ListItem>
                        <ListItemText
                          ...
                          secondary={analytics.performanceMetrics.averageScore.toFixed(
                            1
                          )}
                        />
                      </ListItem>
                  ...
                  <CardContent>
                    ...
                    <Grid container spacing={2}>
                      <Grid item xs={12} md={3}>
                        ...
                        <List dense>
                          {analytics.playerInsights.topPerformers.map(
                            (player, index) => (
                              <ListItem key={index}>
                      ...
                      <Grid item xs={12} md={3}>
                        ...
                        <List dense>
                          {analytics.playerInsights.mostImproved.map(
                            (player, index) => (
                              <ListItem key={index}>
                                <ListItemText primary={player} />
                              </ListItem>
                      ...
                      <Grid item xs={12} md={3}>
                        ...
                        <List dense>
                          {analytics.playerInsights.consistentPlayers.map(
                            (player, index) => (
                              <ListItem key={index}>
                                <ListItemText primary={player} />
                              </ListItem>
                      ...
                      <Grid item xs={12} md={3}>
                        ...
                        <List dense>
                          {analytics.playerInsights.clutchPlayers.map(
                            (player, index) => (
                              <ListItem key={index}>
                                <ListItemText primary={player} />
                              </ListItem>
