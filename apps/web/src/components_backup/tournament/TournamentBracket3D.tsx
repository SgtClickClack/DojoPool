  ...
  const [bracketData, setBracketData] = useState({
    nodes: [
      ...
      },
      {
        ...
        round: 1,
        match: 6,
        player1: 'Christopher White',
        player2: 'Amanda Miller',
        winner: null,
        status: 'pending',
        position: { x: 8, y: 0, z: -10 },
      },
      {
        ...
        round: 1,
        match: 7,
        player1: 'Daniel Taylor',
        player2: 'Jessica Anderson',
        winner: null,
        status: 'pending',
        position: { x: 12, y: 0, z: -10 },
      },
      {
        ...
        round: 1,
        match: 8,
        player1: 'Matthew Martinez',
        player2: 'Nicole Clark',
        winner: null,
        status: 'pending',
    ...
    setBracketData((prev) => ({
      ...
      nodes: prev.nodes.map((node) => {
        ...
        if (node.round > 1 && node.player1 === 'TBD') {
          const connection = prev.connections.find(
        ...
        >
          ...
          <Box position="absolute" top={16} left={16} zIndex={10}>
            <Box display="flex" gap={1}>
              <Button
                ...
                sx={{
                  backgroundColor:
                    currentView === 'default' ? '#00d4ff' : 'transparent',
              ...
              <Button
                ...
                sx={{
                  backgroundColor:
                    currentView === 'closeup' ? '#00d4ff' : 'transparent',
              ...
              <Button
                ...
                sx={{
                  backgroundColor:
                    currentView === 'topdown' ? '#00d4ff' : 'transparent',
          ...
          >
            ...
            {bracketData.connections.map((connection, index) => {
              const fromNode = bracketData.nodes.find(
                (n) => n.id === connection.from
              );
              const toNode = bracketData.nodes.find(
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              ...
              <Slider
                ...
                onChange={(_, value) =>
                  setLighting((prev) => ({ ...prev, ambient: value as number }))
                }
                min={0}
                max={1}
                step={0.1}
