...
const AdvancedMatchCommentary: React.FC = () => {
  ...
  const [selectedEvent, setSelectedEvent] = useState<CommentaryEvent | null>(
    null
  );
  ...
  const [selectedEventForReaction, setSelectedEventForReaction] =
    useState<string>('');
  ...
  return (
    <Box sx={{ p: 3 }}>
                  ...
                  <CardContent>
                    ...
                    >
                      ...
                      <Chip
                        ...
                        color={
                          getToneColor(
                            styles.find((s) => s.id === event.style)?.tone ||
                              'professional'
                          ) as any
                        }
                        size="small"
            ...
            <Grid item xs={12}>
              <Card>
                <CardContent>
                  ...
                  <Grid container spacing={2}>
                    {Object.entries(metrics.popularStyles).map(
                      ([style, count]) => (
      ...
      {tabValue === 3 && (
        <Box>
          <Typography variant="h6" sx={{ mb: 2 }}>
            Real-time Commentary Monitoring
          </Typography>

          <Alert severity="info" sx={{ mb: 2 }}>
            Real-time commentary is{' '}
            {config?.realTimeCommentary ? 'enabled' : 'disabled'}.
            {config?.realTimeCommentary &&
              ' AI is actively generating commentary for live matches.'}
          </Alert>
                ...
                <CardContent>
                  ...
                  >
                    ...
                    >
                      ...
                      <Chip
                        label={
                          config?.realTimeCommentary ? 'Active' : 'Inactive'
                        }
                        color={
                          config?.realTimeCommentary ? 'success' : 'warning'
                        }
                        size="small"
                      />
                    </Box>
                    ...
                    control={
                      <Switch
                        ...
                        onChange={(e) =>
                          setConfig({
                            ...config,
                            realTimeCommentary: e.target.checked,
                          })
                        }
                      />
                    }
                    ...
                    control={
                      <Switch
                        ...
                        onChange={(e) =>
                          setConfig({
                            ...config,
                            autoCommentary: e.target.checked,
                          })
                        }
                      />
                    }
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      setConfig({
                        ...config,
                        commentaryDelay: Number(e.target.value),
                      })
                    }
                  />
                </Grid>
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      setConfig({
                        ...config,
                        maxCommentaryLength: Number(e.target.value),
                      })
                    }
                  />
                </Grid>
                ...
                <Grid item xs={12} md={6}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      onChange={(e) =>
                        setConfig({ ...config, defaultStyle: e.target.value })
                      }
                    >
                        ...
                        control={
                          <Switch
                            ...
                            onChange={(e) =>
                              setConfig({
                                ...config,
                                enableHighlights: e.target.checked,
                              })
                            }
                          />
                        }
          ...
          <Grid container spacing={2} sx={{ pt: 2 }}>
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) =>
                  setNewEvent({ ...newEvent, matchId: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12} md={6}>
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setNewEvent({ ...newEvent, style: e.target.value })
                  }
                >
                  {styles.map((style) => (
                    <MenuItem key={style.id} value={style.id}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                onChange={(e) =>
                  setNewEvent({ ...newEvent, context: e.target.value })
                }
              />
            </Grid>
          </Grid>
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                ...
                <Select
                  value={newStyle.tone}
                  onChange={(e) =>
                    setNewStyle({ ...newStyle, tone: e.target.value as any })
                  }
                >
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                ...
                <Select
                  value={newStyle.pace}
                  onChange={(e) =>
                    setNewStyle({ ...newStyle, pace: e.target.value as any })
                  }
                >
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setNewStyle({ ...newStyle, focus: e.target.value as any })
                  }
                >
                  <MenuItem value="technical">Technical</MenuItem>
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={(e) =>
                      setNewStyle({ ...newStyle, enabled: e.target.checked })
                    }
                  />
                }
                label="Enabled"
          ...
          <Grid container spacing={2} sx={{ pt: 2 }}>
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) =>
                  setNewReaction({ ...newReaction, userId: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) =>
                  setNewReaction({ ...newReaction, userName: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12} md={6}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                onChange={(e) =>
                  setNewReaction({ ...newReaction, content: e.target.value })
                }
              />
            </Grid>
          </Grid>
