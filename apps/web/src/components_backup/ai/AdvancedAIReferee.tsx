...
import AdvancedAIRefereeService, {
  type AIRefereeDecision,
  type AIRefereeAnalysis,
...
const AdvancedAIReferee: React.FC = () => {
  ...
  const [selectedDecision, setSelectedDecision] =
    useState<AIRefereeDecision | null>(null);
  const [selectedAnalysis, setSelectedAnalysis] =
    useState<AIRefereeAnalysis | null>(null);
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      {tabValue === 2 && metrics && (
        <Box>
          <Typography variant="h6" sx={{ mb: 2 }}>
            AI Referee Performance Metrics
          </Typography>
      ...
      {tabValue === 3 && (
        <Box>
          <Typography variant="h6" sx={{ mb: 2 }}>
            Real-time AI Referee Monitoring
          </Typography>

          <Alert severity="info" sx={{ mb: 2 }}>
            Real-time monitoring is{' '}
            {config?.enableRealTimeAnalysis ? 'enabled' : 'disabled'}.
            {config?.enableRealTimeAnalysis &&
              ' AI is actively analyzing matches and making decisions.'}
          </Alert>
                ...
                <CardContent>
                  ...
                  >
                    ...
                    >
                      ...
                      <Chip
                        label={
                          config?.enableRealTimeAnalysis ? 'Active' : 'Inactive'
                        }
                        color={
                          config?.enableRealTimeAnalysis ? 'success' : 'warning'
                        }
                        size="small"
                      />
                    </Box>
                    ...
                    >
                      ...
                      <Chip
                        label={
                          config?.enablePredictiveDecisions
                            ? 'Enabled'
                            : 'Disabled'
                        }
                        color={
                    ...
                    control={
                      <Switch
                        ...
                        onChange={(e) =>
                          setConfig({
                            ...config,
                            enableAppeals: e.target.checked,
                          })
                        }
                      />
                    }
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onChange={(e) =>
                      setConfig({
                        ...config,
                        maxAnalysisDepth: Number(e.target.value),
                      })
                    }
                ...
                <Grid item xs={12}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      onChange={(e) =>
                        setConfig({ ...config, ruleSet: e.target.value as any })
                      }
                    >
      ...
      {/* New Decision Dialog */}
      <Dialog
        open={newDecisionDialogOpen}
        onClose={() => setNewDecisionDialogOpen(false)}
        maxWidth="md"
        fullWidth
      >
          ...
          <Grid container spacing={2} sx={{ pt: 2 }}>
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) =>
                  setNewDecision({ ...newDecision, matchId: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                ...
                >
                  ...
                  <MenuItem value="rule_clarification">
                    Rule Clarification
                  </MenuItem>
                </Select>
              </FormControl>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) =>
                  setNewDecision({ ...newDecision, playerId: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                onChange={(e) =>
                  setNewDecision({ ...newDecision, evidence: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12}>
        ...
        <DialogActions>
          <Button onClick={() => setNewDecisionDialogOpen(false)}>
            Cancel
          </Button>
          ...
          <Grid container spacing={2} sx={{ pt: 2 }}>
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) =>
                  setNewAnalysis({ ...newAnalysis, matchId: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12} md={6}>
              <FormControl fullWidth>
                ...
                >
                  ...
                  <MenuItem value="rule_interpretation">
                    Rule Interpretation
                  </MenuItem>
                  <MenuItem value="strategy_recommendation">
                    Strategy Recommendation
                  </MenuItem>
                  <MenuItem value="performance_assessment">
            ...
            <Grid item xs={12}>
              <TextField
                ...
                onChange={(e) =>
                  setNewAnalysis({ ...newAnalysis, content: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                onChange={(e) =>
                  setNewAnalysis({ ...newAnalysis, insights: e.target.value })
                }
              />
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                onChange={(e) =>
                  setNewAnalysis({ ...newAnalysis, context: e.target.value })
                }
              />
            </Grid>
          </Grid>
