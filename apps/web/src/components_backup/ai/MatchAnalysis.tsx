...
const MatchAnalysisComponent: React.FC = () => {
  ...
  const loadMockAnalysis = async () => {
    ...
    try {
      ...
      const program = await analysisService.generateTrainingProgram(
        'player1',
        analysis.player1Performance
      );
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            ...
            {[
              ...
              {
                label: 'Strategy',
                value: performance.strategy,
                color: '#feca57',
              },
              {
                label: 'Pressure Handling',
                value: performance.pressureHandling,
                color: '#ff9ff3',
              },
              {
                label: 'Shot Selection',
                value: performance.shotSelection,
                color: '#54a0ff',
              },
              {
                label: 'Positioning',
              ...
              >
                <ListItemIcon>
                  <Avatar
                    sx={{
                      backgroundColor:
                        moment.impact === 'positive' ? '#00ff9d' : '#ff6b6b',
                      color: '#000',
                      width: 32,
                      height: 32,
                    }}
          ...
          <Grid container spacing={3}>
            <Grid item xs={12}>
              {renderPerformanceCard(
                matchAnalysis.player1Performance,
                'Player 1 Performance'
              )}
            </Grid>
            <Grid item xs={12}>
              {renderPerformanceCard(
                matchAnalysis.player2Performance,
