...
const MOCK_SESSIONS: AdvancedAnalysisSession[] = [
  {
    ...
    performance: 85,
    notes:
      'Excellent progress on break shots. Advanced tactical understanding demonstrated. Need to work on pressure situations.',
    coachRating: 4,
    mentalGameScore: 78,
    tacticalScore: 82,
    physicalScore: 88,
  },
  {
    ...
    performance: 78,
    notes:
      'Good understanding of safety concepts. Advanced tactical thinking improving. More practice needed on execution under pressure.',
    coachRating: 3,
    mentalGameScore: 72,
    tacticalScore: 85,
    physicalScore: 75,
...
const AdvancedMatchAnalysis: React.FC = () => {
  ...
  const [selectedSession, setSelectedSession] =
    useState<AdvancedAnalysisSession | null>(null);
  ...
  const startAdvancedAnalysis = useCallback(
        ...
        <TabPanel value={tabValue} index={0}>
          {isAnalysisActive && selectedSession ? (
            <Box>
              <Typography
                variant="h5"
                sx={{ color: '#00d4ff', mb: 3, fontWeight: 'bold' }}
              >
                Advanced Analysis in Progress
              </Typography>
              <Typography variant="body1" color="text.secondary">
                Analyzing: {selectedSession.focusArea} - {analysisProgress}%
                Complete
              </Typography>
            </Box>
          ) : (
