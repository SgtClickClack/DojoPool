...
const CoachingSystem: React.FC = () => {
  ...
  const loadMockData = async () => {
    ...
    const program1 = await analysisService.generateTrainingProgram(
      'player1',
      mockPerformance
    );
    ...
    const sessions: CoachingSession[] = [
      {
        ...
        performance: 85,
        notes:
          'Excellent progress on break shots. Need to work on cue ball positioning.',
        coachRating: 4,
      },
      {
        id: 'session_2',
        ...
        performance: 78,
        notes:
          'Good understanding of safety concepts. More practice needed on execution.',
        coachRating: 3,
      },
    ];
