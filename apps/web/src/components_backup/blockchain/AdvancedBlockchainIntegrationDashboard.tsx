    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="subtitle1" color="text.secondary" gutterBottom>
          ...
          interactions, and cross-chain operations
        </Typography>
              ...
              <TableBody>
                {tokens.map((token) => (
                  <TableRow key={token.id}>
                    ...
                    <TableCell>
                      {
                        collections.find((c) => c.id === token.collectionId)
                          ?.name
                      }
                    </TableCell>
              ...
              <Grid item xs={12} md={6} key={bridge.id}>
                <Card>
                  <CardContent>
                    ...
                    >
                      <Typography variant="body2">
                        {getChainName(bridge.sourceChain)} →{' '}
                        {getChainName(bridge.destinationChain)}
                      </Typography>
                      <Chip
          ...
          <Grid item xs={12} md={6}>
            <Card>
              <CardContent>
                ...
                <List>
                  {tokens
                    .filter((t) => t.marketData.isListed)
                    .map((token) => (
            ...
            <Grid item xs={12} md={6}>
              <Card>
                <CardContent>
                  ...
                  {Object.entries(analytics.chainUsage).map(
                    ([chainId, usage]) => (
                      <Box key={chainId} sx={{ mb: 2 }}>
                        ...
                        <LinearProgress
                          variant="determinate"
                          value={
                            (usage.transactions / analytics.totalTransactions) *
                            100
                          }
                        />
                      </Box>
      ...
      <Dialog
        open={openDialogs.createCollection || false}
        onClose={() => handleCloseDialog('createCollection')}
        maxWidth="sm"
        fullWidth
      >
        ...
        <DialogContent>
          ...
          <TextField
            ...
            onChange={(e) =>
              handleFormChange('totalSupply', parseInt(e.target.value))
            }
            margin="normal"
          />
          <TextField
            ...
            onChange={(e) =>
              handleFormChange('mintPrice', parseFloat(e.target.value))
            }
            margin="normal"
          />
          <TextField
            ...
            onChange={(e) =>
              handleFormChange('contractAddress', e.target.value)
            }
            margin="normal"
          />
          <TextField
            ...
            onChange={(e) =>
              handleFormChange('chainId', parseInt(e.target.value))
            }
            margin="normal"
          />
        </DialogContent>
        <DialogActions>
          <Button onClick={() => handleCloseDialog('createCollection')}>
            Cancel
          </Button>
      ...
      {/* Mint NFT Dialog */}
      <Dialog
        open={openDialogs.mintNFT || false}
        onClose={() => handleCloseDialog('mintNFT')}
        maxWidth="sm"
        fullWidth
      >
        ...
        <DialogActions>
          ...
          <Button onClick={handleMintNFT} variant="contained">
            Mint
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog
        open={openDialogs.deployContract || false}
        onClose={() => handleCloseDialog('deployContract')}
        maxWidth="md"
        fullWidth
      >
        ...
        <DialogContent>
          ...
          <TextField
            ...
            value={formData.abi || ''}
            onChange={(e) =>
              handleFormChange('abi', JSON.parse(e.target.value))
            }
            margin="normal"
            multiline
            rows={4}
        ...
        <DialogActions>
          <Button onClick={() => handleCloseDialog('deployContract')}>
            Cancel
          </Button>
          <Button onClick={handleDeployContract} variant="contained">
            Deploy
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog
        open={openDialogs.createBridge || false}
        onClose={() => handleCloseDialog('createBridge')}
        maxWidth="sm"
        fullWidth
      >
        ...
        <DialogContent>
          ...
          <TextField
            ...
            onChange={(e) =>
              handleFormChange('sourceChain', parseInt(e.target.value))
            }
            margin="normal"
          />
          <TextField
            ...
            onChange={(e) =>
              handleFormChange('destinationChain', parseInt(e.target.value))
            }
            margin="normal"
          />
          <TextField
          ...
          <TextField
            ...
            onChange={(e) =>
              handleFormChange('destinationToken', e.target.value)
            }
            margin="normal"
          />
          <TextField
          ...
          <TextField
            ...
            value={formData.fee || ''}
            onChange={(e) =>
              handleFormChange('fee', parseFloat(e.target.value))
            }
            margin="normal"
          />
        </DialogContent>
        <DialogActions>
          <Button onClick={() => handleCloseDialog('createBridge')}>
            Cancel
          </Button>
          <Button onClick={handleCreateBridge} variant="contained">
            Create
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog
        open={openDialogs.connectWallet || false}
        onClose={() => handleCloseDialog('connectWallet')}
        maxWidth="sm"
        fullWidth
      >
        ...
        <DialogActions>
          <Button onClick={() => handleCloseDialog('connectWallet')}>
            Cancel
          </Button>
      ...
      {/* List NFT Dialog */}
      <Dialog
        open={openDialogs.listNFT || false}
        onClose={() => handleCloseDialog('listNFT')}
        maxWidth="sm"
        fullWidth
      >
          ...
          >
            {tokens.map((token) => (
              <option key={token.id} value={token.id}>
                Token #{token.tokenId} -{' '}
                {collections.find((c) => c.id === token.collectionId)?.name}
              </option>
            ))}
          </TextField>
          <TextField
        ...
        <DialogActions>
          ...
          <Button onClick={handleListNFT} variant="contained">
            List
          </Button>
        </DialogActions>
      </Dialog>
      ...
      {/* Buy NFT Dialog */}
      <Dialog
        open={openDialogs.buyNFT || false}
        onClose={() => handleCloseDialog('buyNFT')}
        maxWidth="sm"
        fullWidth
      >
        ...
        <DialogContent>
          ...
          >
            {tokens
              ...
              .map((token) => (
                <option key={token.id} value={token.id}>
                  Token #{token.tokenId} - {token.marketData.listingPrice}{' '}
                  {token.marketData.listingCurrency}
                </option>
              ))}
          </TextField>
          <TextField
      ...
      <Dialog
        open={openDialogs.bridgeTokens || false}
        onClose={() => handleCloseDialog('bridgeTokens')}
        maxWidth="sm"
        fullWidth
      >
            ...
            {bridges
              ...
              .map((bridge) => (
                <option key={bridge.id} value={bridge.id}>
                  {bridge.name} ({getChainName(bridge.sourceChain)} →{' '}
                  {getChainName(bridge.destinationChain)})
                </option>
              ))}
          </TextField>
        ...
        <DialogActions>
          <Button onClick={() => handleCloseDialog('bridgeTokens')}>
            Cancel
          </Button>
          <Button onClick={handleBridgeTokens} variant="contained">
            Bridge
          </Button>
        </DialogActions>
      </Dialog>
