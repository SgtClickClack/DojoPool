...
import {
  ...
  BlockchainNetwork,
  NFTRarity,
} from '../../hooks/useAdvancedBlockchainIntegration';
    ...
    <div style={{ padding: 32 }}>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <form onSubmit={handleMint}>
          ...
          <input
            ...
            onChange={(e) =>
              setMintForm((f) => ({ ...f, description: e.target.value }))
            }
          />
          <input
            ...
            onChange={(e) =>
              setMintForm((f) => ({ ...f, image: e.target.value }))
            }
          />
          <input
            placeholder="Creator Address"
            value={mintForm.creator}
            onChange={(e) =>
              setMintForm((f) => ({ ...f, creator: e.target.value }))
            }
          />
          <input
            ...
            onChange={(e) =>
              setMintForm((f) => ({ ...f, contractAddress: e.target.value }))
            }
          />
          <select
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <form onSubmit={handleTransfer}>
          <input
            ...
            onChange={(e) =>
              setTransferForm((f) => ({ ...f, tokenId: e.target.value }))
            }
          />
          <input
            placeholder="Contract Address"
          ...
          <input
            ...
            onChange={(e) =>
              setTransferForm((f) => ({ ...f, fromAddress: e.target.value }))
            }
          />
          <input
            ...
            onChange={(e) =>
              setTransferForm((f) => ({ ...f, toAddress: e.target.value }))
            }
          />
          <select
          ...
          <input
            ...
            onChange={(e) =>
              setTransferForm((f) => ({ ...f, price: e.target.value }))
            }
          />
          <input
            ...
            onChange={(e) =>
              setTransferForm((f) => ({ ...f, currency: e.target.value }))
            }
          />
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <form onSubmit={handleEvolve}>
          <input
            placeholder="Token ID"
            value={evolveForm.tokenId}
            onChange={(e) =>
              setEvolveForm((f) => ({ ...f, tokenId: e.target.value }))
            }
          />
          <input
            placeholder="Contract Address"
            value={evolveForm.contractAddress}
            onChange={(e) =>
              setEvolveForm((f) => ({ ...f, contractAddress: e.target.value }))
            }
          />
          <select
            value={evolveForm.network}
            onChange={(e) =>
              setEvolveForm((f) => ({
                ...f,
                network: e.target.value as BlockchainNetwork,
          ...
          <input
            ...
            type="number"
            value={evolveForm.newStage}
            onChange={(e) =>
              setEvolveForm((f) => ({ ...f, newStage: Number(e.target.value) }))
            }
          />
          <input
            placeholder="New Abilities (comma separated)"
            value={evolveForm.newAbilities}
            onChange={(e) =>
              setEvolveForm((f) => ({ ...f, newAbilities: e.target.value }))
            }
          />
          <input
            placeholder="Power Increase"
            type="number"
            value={evolveForm.powerIncrease}
            onChange={(e) =>
              setEvolveForm((f) => ({
                ...f,
                powerIncrease: Number(e.target.value),
              }))
            }
          />
