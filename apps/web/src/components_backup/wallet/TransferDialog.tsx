...
export const TransferDialog: React.FC<TransferDialogProps> = ({
  ...
  const cyberDialogStyle = {
    '& .MuiDialog-paper': {
      ...
      borderRadius: '15px',
      boxShadow:
        '0 0 30px rgba(0, 255, 157, 0.3), inset 0 0 30px rgba(0, 255, 157, 0.1)',
  ...
  const neonTextStyle = {
    color: '#fff',
    textShadow:
      '0 0 10px rgba(0, 255, 157, 0.8), 0 0 20px rgba(0, 255, 157, 0.4)',
    fontWeight: 700,
    letterSpacing: '1px',
    textTransform: 'uppercase' as const,
  };
  ...
  return (
    <Dialog
      ...
      sx={cyberDialogStyle}
    >
      <DialogTitle sx={neonTextStyle}>Transfer Dojo Coins</DialogTitle>
