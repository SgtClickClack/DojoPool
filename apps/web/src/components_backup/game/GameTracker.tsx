...
import { GameState, type Player, Foul, type Rule } from '../../types/game';
...
export const GameTracker: React.FC<GameTrackerProps> = ({
  ...
  const { gameState, updateScore, addFoul, undoLastAction } =
  ...
  const renderPlayerCard = (player: Player, isPlayer1: boolean) => (
    <Card
      sx={{
        ...
        borderRadius: 2,
        borderLeft: isPlayer1
          ? `4px solid ${theme.palette.primary.main}`
          : 'none',
        borderRight: !isPlayer1
      ...
      <CardContent>
        ...
        >
          ...
          <Chip
            ...
            color={
              gameState?.fouls[player.id]?.length >= 3 ? 'error' : 'default'
            }
          />
        </Box>
