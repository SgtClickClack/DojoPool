...
import { type Clan } from '../../services/clan/ClanSystemService';
              ...
              >
                <CardContent sx={{ p: 4, textAlign: 'center' }}>
                  ...
                  <Typography variant="body2" sx={{ color: '#ccc', mb: 3 }}>
                    Join or create a clan to participate in clan wars and
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={3}>
                      <Box sx={{ textAlign: 'center' }}>
                        <EmojiEvents
                          sx={{ color: '#00ff9d', fontSize: 28, mb: 1 }}
                        />
                        <Typography variant="h6" sx={{ color: '#00ff9d' }}>
                          {userClan.totalWins}
                        </Typography>
                  ...
                  {loading.members ? (
                    <Typography
                      sx={{ textAlign: 'center', color: '#ccc', mt: 3 }}
                    >
                      Loading members...
                    </Typography>
                  ) : (
            ...
            {loading.wars ? (
              ...
              >
                <CardContent sx={{ p: 4, textAlign: 'center' }}>
                  ...
                  <Typography variant="body2" sx={{ color: '#ccc', mb: 3 }}>
                    Your clan is not currently engaged in any wars. Challenge a
                    rival clan to start a battle!
                  </Typography>
                </CardContent>
              </Card>
            ) : (
                    ...
                    <CardContent sx={{ p: 3 }}>
                      ...
                      >
                        ...
                        <Chip
                          ...
                          sx={{
                            backgroundColor:
                              war.status === 'active' ? '#ff6b6b' : '#00a8ff',
                            color: '#000',
                            fontWeight: 'bold',
                          }}
                        />
            ...
            {loadingRivals ? (
              ...
              >
                <CardContent sx={{ p: 4, textAlign: 'center' }}>
                  ...
                  <Typography variant="body2" sx={{ color: '#ccc', mb: 3 }}>
                    There are no other clans available to challenge at the
                    moment.
                  </Typography>
                </CardContent>
              </Card>
                ...
                {rivalClans.map((clan) => (
                  ...
                  >
                    <CardContent sx={{ p: 3 }}>
                      ...
                      <Divider
                        sx={{ my: 2, borderColor: 'rgba(254, 202, 87, 0.3)' }}
                      />
