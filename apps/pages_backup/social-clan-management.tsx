...
export default function SocialClanManagementPage() {
  const [activeSection, setActiveSection] = useState<'social' | 'clan'>(
    'social'
  );
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">
            Social & Clan Management
          </h1>
          <p className="text-gray-600">
            Manage your social connections, friends, messaging, and clan
            activities
          </p>
        </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Add friends, see their status, and manage connections
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Send messages, challenges, and clan invites
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Share achievements, match results, and social
                          interactions
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3 p-3 bg-orange-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Search for players and discover new friends
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3 p-3 bg-red-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Create, manage, and lead your own clan
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3 p-3 bg-yellow-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Promote, demote, and manage clan members
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Declare war on other clans and compete for glory
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Find and join the best clans in the game
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3 p-2 bg-gray-50 rounded">
                      ...
                      <div>
                        <p className="text-sm font-medium">
                          Won clan war against "Dragon Slayers"
                        </p>
                    ...
                    <div className="flex items-center space-x-3 p-2 bg-gray-50 rounded">
                      ...
                      <div>
                        <p className="text-sm font-medium">
                          New member joined: "ShadowStriker"
                        </p>
                    ...
                    <div className="flex items-center space-x-3 p-2 bg-gray-50 rounded">
                      ...
                      <div>
                        <p className="text-sm font-medium">
                          Captured new territory: "Jade District"
                        </p>
                    ...
                    <div className="flex items-center space-x-3 p-2 bg-gray-50 rounded">
                      ...
                      <div>
                        <p className="text-sm font-medium">
                          Declared war on "Phoenix Rising"
                        </p>
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Social features integrated with territory battles, tournaments,
                and match results
              </p>
            </div>
            <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Clan rewards, social transactions, and economic incentives for
                collaboration
              </p>
            </div>
            <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                AI commentary for clan wars, social recommendations, and
                activity analysis
              </p>
            </div>
          </div>
