        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real-time shot tracking, performance analytics, and AI coaching
              insights powered by advanced computer vision and machine learning.
            </p>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Advanced computer vision tracks ball positions, shot types,
                power, spin, and accuracy in real-time.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Comprehensive analysis of accuracy, consistency, strategy, and
                pressure handling with detailed metrics.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Intelligent coaching recommendations based on current situation,
                player performance, and match context.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                AI-powered predictions for match outcomes, next shot
                probabilities, and strategic recommendations.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Analysis of focus, confidence, pressure handling, and emotional
                control with personalized mental coaching.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                AI-generated training programs tailored to individual weaknesses
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-gray-600">
                  <li>
                    • Computer Vision for ball tracking and position detection
                  </li>
