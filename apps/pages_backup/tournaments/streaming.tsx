    ...
    <CyberpunkContainer maxWidth={false}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ color: 'text.secondary', mb: 3 }}>
          Experience real-time tournament matches with AI-enhanced commentary
          ...
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
            <Box sx={{ flex: '1 1 300px' }}>
              <Box sx={{ mb: 2 }}>
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  1080p HD streaming at 60 FPS with adaptive bitrate for optimal
                  viewing experience
                </Typography>
              </Box>
            </Box>
            <Box sx={{ flex: '1 1 300px' }}>
              <Box sx={{ mb: 2 }}>
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  Real-time AI-powered commentary with shot analysis and
                  strategic insights
                </Typography>
              </Box>
            </Box>
            <Box sx={{ flex: '1 1 300px' }}>
              <Box sx={{ mb: 2 }}>
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  Real-time player statistics, shot accuracy, and performance
                  metrics
                </Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ flex: '1 1 300px' }}>
              <Box sx={{ mb: 2 }}>
                <Typography
                  variant="h6"
                  sx={{ color: neonColors.error, mb: 1 }}
                >
                  ⚡ Low Latency
                </Typography>
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
