          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-blue-100">
                AI-powered performance optimization and predictive insights for
                venue success
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-sm bg-white bg-opacity-20 px-3 py-1 rounded">
                    Last Updated:{' '}
                    {systemStatus?.lastUpdated?.toLocaleTimeString() || 'N/A'}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  AI-driven recommendations to maximize revenue, efficiency, and
                  player satisfaction through data-driven insights.
                </p>
              </div>
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Forecast revenue trends, player growth, and equipment needs
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Compare performance against industry standards and similar
                  venues to identify improvement opportunities.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-lg shadow-sm p-6">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    <div className="text-center">
                      <div
                        className={`text-3xl font-bold mb-2 ${getHealthColor(systemStatus.overallHealth)}`}
                      >
                    ...
                    <div className="text-center">
                      <div
                        className={`text-3xl font-bold mb-2 ${getServiceStatusColor(systemStatus.services.analytics)}`}
                      >
                        ●
                      </div>
                    ...
                    <div className="text-center">
                      <div
                        className={`text-3xl font-bold mb-2 ${getServiceStatusColor(systemStatus.services.predictions)}`}
                      >
                        ●
                      </div>
                    ...
                    <div className="text-center">
                      <div
                        className={`text-3xl font-bold mb-2 ${getServiceStatusColor(systemStatus.services.optimization)}`}
                      >
                        ●
                      </div>
            ...
            <div className="max-w-4xl mx-auto mb-8">
              ...
              <div className="bg-white rounded-lg shadow-sm p-4">
                ...
                >
                  ...
                  <option value="venue_002">
                    DojoPool North - Business District
                  </option>
                  <option value="venue_003">
                    DojoPool South - Entertainment Zone
                  </option>
                  <option value="venue_004">
                    DojoPool East - University Area
                  </option>
                </select>
              </div>
            </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium text-green-600">
                            +{optimization.expectedImpact.revenueIncrease}%
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Cost Reduction:</span>
                          <span className="font-medium text-blue-600">
                            -{optimization.expectedImpact.costReduction}%
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">
                          ...
                          <span className="font-medium text-purple-600">
                            +{optimization.expectedImpact.efficiencyGain}%
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Priority:</span>
                          <span className="font-medium capitalize">
                            {optimization.implementationPriority}
                          </span>
                        </div>
                      </div>
                    </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Real-time data collection from venue operations, player
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Generate actionable recommendations for revenue, operations,
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Track implementation progress and measure impact of
                  optimizations.
                </p>
              </div>
            </div>
        ...
        <div className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">
              Join the future of venue management with AI-powered analytics and
              predictive insights.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                onClick={() =>
                  (window.location.href = '/venue/venue-management')
                }
