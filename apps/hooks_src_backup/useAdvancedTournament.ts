...
export const useAdvancedTournament = (): UseAdvancedTournamentReturn => {
  ...
  const createTournament = useCallback(
    async (config: AdvancedTournamentConfig): Promise<Tournament> => {
  ...
  const generateBracket = useCallback(
    async (tournamentId: string): Promise<TournamentBracket> => {
      const data = await apiCall<{ bracket: TournamentBracket }>(
  ...
  const registerPlayer = useCallback(
    async (tournamentId: string, playerId: string): Promise<void> => {
  ...
  const generateAnalytics = useCallback(
    async (tournamentId: string): Promise<TournamentAnalytics> => {
      const data = await apiCall<{ analytics: TournamentAnalytics }>(
        `/${tournamentId}/analytics`
      );
  ...
  const generateInsights = useCallback(
    async (tournamentId: string): Promise<TournamentInsights> => {
      const data = await apiCall<{ insights: TournamentInsights }>(
        `/${tournamentId}/insights`
      );
  ...
  const getMatchAnalytics = useCallback(
    async (matchId: string): Promise<MatchAnalytics> => {
      const data = await apiCall<{ analytics: MatchAnalytics }>(
