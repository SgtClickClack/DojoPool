...
export class DeploymentManager {
  ...
  private loadConfiguration(): DeploymentConfig {
    ...
    const envConfig =
      environmentConfigs[this.environment as keyof EnvironmentConfig] || {};
  ...
  generateEnvVars(): Record<string, string> {
    return {
      ...
      REACT_APP_SERVICE_WORKER_ENABLED:
        this.config.serviceWorkerEnabled.toString(),
...
export const isFeatureEnabled = (feature: keyof DeploymentConfig) =>
  deploymentManager.isFeatureEnabled(feature);
export const getEnvironmentValue = <T>(key: keyof DeploymentConfig) =>
  deploymentManager.getEnvironmentValue<T>(key);
export const validateDeploymentConfig = () =>
  deploymentManager.validateConfig();
export const generateEnvVars = () => deploymentManager.generateEnvVars();
export const generateBuildConfig = () =>
  deploymentManager.generateBuildConfig();
