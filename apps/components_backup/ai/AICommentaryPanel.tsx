    ...
    >
      <ListItemAvatar>
        <Avatar
          sx={{
            backgroundColor:
              godColors[event.poolGod as keyof typeof godColors] || '#666',
            width: 40,
            height: 40,
          }}
        >
    ...
    return (
      <Card sx={{ minHeight: 200 }}>
        <CardContent>
          ...
          <Alert severity="info">Connect to a match to see AI commentary</Alert>
        </CardContent>
      </Card>
    );
  }
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Typography variant="h6">Pool God Commentary</Typography>
            <Badge
        ...
        <Collapse in={showSettingsPanel}>
          <Paper
            sx={{ p: 2, mb: 2, backgroundColor: 'rgba(255, 255, 255, 0.05)' }}
          >
              ...
              <Chip
                ...
                avatar={
                  <Avatar
                    sx={{
                      backgroundColor:
                        godColors[god.id as keyof typeof godColors],
                    }}
                  >
