  ...
  const generateExplanation = (analysis: any): string => {
    const explanations = {
      'Ball in Hand Violation':
        'The cue ball was moved without proper ball-in-hand rights. Sky-T1 AI detected unauthorized movement based on game state and previous foul status.',
      'Double Tap':
        'High-speed analysis shows the cue tip contacted the cue ball twice during the stroke. Frame-by-frame analysis confirms violation.',
      'Wrong Ball First':
        "Ball trajectory analysis indicates the cue ball contacted an opponent's ball before hitting a legal target ball.",
      'Push Shot':
        'Cue stick contact duration exceeded legal limits. AI measured extended contact through motion analysis.',
      'Legal Jump Shot':
        'Shot analysis confirms legal execution with proper cue elevation and contact point.',
      'Ball Off Table':
        'Object ball trajectory exceeded table boundaries. Confirmed through 3D position tracking.',
    };

    return (
      explanations[analysis.category] ||
        ...
        prev.map((d) =>
          d.id === appealDialog.id
            ? {
                ...d,
                type: 'no-foul',
                description: 'Decision overturned on appeal',
              }
            : d
        )
      );
                    ...
                    <ListItemText
                      primary={
                        ...
                        >
                          ...
                          <Chip
                            ...
                            sx={{
                              background: alpha(
                                getSeverityColor(decision.severity),
                                0.2
                              ),
                      ...
                      secondary={
                        <>
                          ...
                          >
                            {moment(decision.timestamp).fromNow()} • Confidence:{' '}
