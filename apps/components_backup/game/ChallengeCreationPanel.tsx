...
const ChallengeCreationPanel: React.FC<ChallengeCreationPanelProps> = ({
  ...
  const getChallengeDescription = (type: string) => {
    const descriptions = {
      pilgrimage:
        'Embark on a legendary journey to defeat the Dojo Master and claim this venue as your own. This is the ultimate test of skill and determination.',
      gauntlet:
        "Face a series of challenging matches against the venue's top players. Prove your worth through multiple victories.",
                  ...
                  <MenuItem key={player.id} value={player.id}>
                    ...
                    >
                      ...
                      <Box sx={{ display: 'flex', gap: 0.5 }}>
                        ...
                        {player.isMaster && (
                          <EmojiEvents color="secondary" fontSize="small" />
                        )}
                      </Box>
                    </Box>
                  </MenuItem>
          ...
          <Grid item xs={12}>
            <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
              ...
              <Button
                ...
                startIcon={
                  isLoading ? <CircularProgress size={20} /> : <EmojiEvents />
                }
              >
      ...
      >
        ...
        <DialogContent>
          ...
          <Alert severity="warning" sx={{ mt: 2 }}>
            <Typography variant="body2">
              This challenge will be active for 7 days. Make sure you're ready
              to compete!
            </Typography>
          </Alert>
        </DialogContent>
