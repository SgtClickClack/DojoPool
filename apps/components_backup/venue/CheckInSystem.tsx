...
export const CheckInSystem: React.FC<CheckInSystemProps> = ({
  ...
  const [checkInMethod, setCheckInMethod] = useState<'qr' | 'geo' | 'manual'>(
    'qr'
  );
  ...
  const fetchData = async () => {
    try {
      ...
      if (user) {
        setIsCheckedIn(
          active.some((checkin: any) => checkin.userId === user.uid)
        );
      }
    } catch (error) {
      ...
      <Box sx={{ width: '100%', mt: 2 }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
          ...
          <Typography variant="body2" sx={{ color: neonColors.warning }}>
            ...
            {occupancyStats?.maxCapacity || 100}
          </Typography>
        </Box>
        <LinearProgress
          variant="determinate"
                      ...
                      secondary={
                        ...
                        >
                          ...
                          {checkin.checkedOutAt && (
                            ...
                            >
                              Out:{' '}
                              {moment(checkin.checkedOutAt).format('h:mm A')}
                            </Typography>
                          )}
                          <Typography
                            variant="caption"
          ...
          <Box sx={{ mt: 2 }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                ...
                >
                  <QrCodeScanner
                    sx={{ fontSize: 48, color: neonColors.primary, mb: 1 }}
                  />
              ...
              <Grid item xs={12} sm={6}>
                ...
                >
                  <LocationOn
                    sx={{ fontSize: 48, color: neonColors.info, mb: 1 }}
                  />
