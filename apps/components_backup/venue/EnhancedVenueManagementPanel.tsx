          ...
          <Grid container spacing={2}>
            {venues.map((venue) => (
              <Grid item xs={12} sm={6} md={4} key={venue.id}>
                <Card
                  variant={
                    selectedVenue?.id === venue.id ? 'elevation' : 'outlined'
                  }
                  sx={{
                    cursor: 'pointer',
                    '&:hover': { boxShadow: 2 },
        ...
        <>
          ...
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
            <Tabs
              ...
              aria-label="venue management tabs"
            >
                ...
                <Card>
                  <CardContent>
                    ...
                    {statusLoading ? (
                      ...
                      <Box>
                        {Object.entries(status.systemHealth).map(
                          ([component, healthy]) => (
                            <Box
                              key={component}
                              sx={{
                      ...
                      <Grid container spacing={2}>
                        <Grid item xs={6}>
                          ...
                          <Typography
                            variant="h6"
                            color={
                              analytics.trends.visitorGrowth >= 0
                                ? 'success.main'
                                : 'error.main'
                            }
                          >
                            {analytics.trends.visitorGrowth > 0 ? '+' : ''}
                            {analytics.trends.visitorGrowth.toFixed(1)}%
                          </Typography>
                        </Grid>
                        <Grid item xs={6}>
                          <Typography variant="body2" color="text.secondary">
                        ...
                        <Grid item xs={6}>
                          ...
                          <Typography
                            variant="h6"
                            color={
                              analytics.trends.matchGrowth >= 0
                                ? 'success.main'
                                : 'error.main'
                            }
                          >
                            {analytics.trends.matchGrowth > 0 ? '+' : ''}
                            {analytics.trends.matchGrowth.toFixed(1)}%
                          </Typography>
                        </Grid>
                        <Grid item xs={6}>
                          <Typography variant="body2" color="text.secondary">
                          ...
                          <Typography
                            variant="h6"
                            color={
                              analytics.trends.tournamentGrowth >= 0
                                ? 'success.main'
                                : 'error.main'
                            }
                          >
                            {analytics.trends.tournamentGrowth > 0 ? '+' : ''}
                            {analytics.trends.tournamentGrowth.toFixed(1)}%
                          </Typography>
                        </Grid>
                      </Grid>
                    </CardContent>
                        ...
                        >
                          ...
                          <Box>
                            ...
                            <Switch
                              ...
                              onChange={(e) =>
                                updateTournamentSchedule(schedule.id, {
                ...
                <Grid item xs={12} md={6}>
                  <Card>
                    <CardContent>
                      ...
                      {optimization.pricingAnalysis.competitorAnalysis.map(
                        (competitor) => (
                          <Box
                      ...
                      <Grid container spacing={3}>
                        <Grid item xs={12} sm={6} md={4}>
                          <Box sx={{ textAlign: 'center' }}>
                            <Typography variant="h4" color="primary.main">
                              {(
                                performance.kpis.visitorSatisfaction * 100
                              ).toFixed(1)}
                              %
                            </Typography>
                            <Typography variant="body2" color="text.secondary">
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                          <Box sx={{ textAlign: 'center' }}>
                            <Typography variant="h4" color="primary.main">
                              {(
                                performance.kpis.tableUtilization * 100
                              ).toFixed(1)}
                              %
                            </Typography>
                            <Typography variant="body2" color="text.secondary">
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                          <Box sx={{ textAlign: 'center' }}>
                            <Typography variant="h4" color="primary.main">
                              {(
                                performance.kpis.tournamentSuccess * 100
                              ).toFixed(1)}
                              %
                            </Typography>
                            <Typography variant="body2" color="text.secondary">
                        ...
                        <Table>
                          ...
                          <TableBody>
                            <TableRow>
                              ...
                              <TableCell align="right">
                                {(
                                  performance.benchmarks.topPerformers
                                    .visitorSatisfaction * 100
                                ).toFixed(1)}
                                %
                              </TableCell>
          ...
          <Grid container spacing={2} sx={{ mt: 1 }}>
            ...
            <Grid item xs={12}>
              <FormControlLabel
                control={
                  <Switch
                    defaultChecked={selectedSchedule?.autoCreate || false}
                  />
                }
            ...
            <Grid item xs={12}>
              <FormControlLabel
                control={
                  <Switch defaultChecked={selectedSchedule?.enabled || true} />
                }
                label="Enabled"
              />
            </Grid>
