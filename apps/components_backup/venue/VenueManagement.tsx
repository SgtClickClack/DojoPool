  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setMaintenanceSchedules(
        venueService.getMaintenanceSchedules(selectedVenue)
      );
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        >
          {isConnected
            ? 'Connected to venue management service'
            : 'Disconnected from venue management service'}
        </Alert>
      </Box>
                ...
                <CardContent>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12} md={6}>
                      ...
                      <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
                        Customer Satisfaction: {analytics.customerSatisfaction}
                        /5
                      </Typography>
                      <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) =>
                            venueService.updateConfig({
                              enableHardwareMonitoring: e.target.checked,
                            })
                          }
                          sx={{
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) =>
                            venueService.updateConfig({
                              enableAutomatedMaintenance: e.target.checked,
                            })
                          }
                          sx={{
                            '& .MuiSwitch-switchBase.Mui-checked': {
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) =>
                            venueService.updateConfig({
                              enableSmartLighting: e.target.checked,
                            })
                          }
                          sx={{
                            '& .MuiSwitch-switchBase.Mui-checked': {
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) =>
                            venueService.updateConfig({
                              enableClimateControl: e.target.checked,
                            })
                          }
                          sx={{
                            '& .MuiSwitch-switchBase.Mui-checked': {
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) =>
                            venueService.updateConfig({
                              enableSecurityMonitoring: e.target.checked,
                            })
                          }
                          sx={{
                            '& .MuiSwitch-switchBase.Mui-checked': {
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) =>
                            venueService.updateConfig({
                              enablePaymentIntegration: e.target.checked,
                            })
                          }
                          sx={{
                            '& .MuiSwitch-switchBase.Mui-checked': {
              ...
              <CardContent>
                ...
                {config && (
                  <Box>
                    <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
                      Temperature Range:{' '}
                      {config.alertThresholds.temperature.min}°C -{' '}
                      {config.alertThresholds.temperature.max}°C
                    </Typography>
                    <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
                      Humidity Range: {config.alertThresholds.humidity.min}% -{' '}
                      {config.alertThresholds.humidity.max}%
                    </Typography>
                    <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
                    ...
                    <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
                      Revenue Alert:{' '}
                      {formatCurrency(config.alertThresholds.revenue)}
                    </Typography>
                    <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
