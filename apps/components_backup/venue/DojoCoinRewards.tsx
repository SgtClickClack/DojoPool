    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="h6" color="text.secondary" sx={{ mb: 2 }}>
          Advanced reward system with loyalty programs, campaigns, and automated
          distribution
        </Typography>
      </Box>
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            >
              <CardContent>
                ...
                <Typography variant="h4">
                  {analytics.loyaltyStats?.totalPlayers || 0}
                </Typography>
                <Typography variant="body2">
                  ...
                  <CardContent>
                    ...
                    >
                      ...
                      <Typography variant="body2" color="text.secondary">
                        ...
                        {reward.maxRedemptions || '∞'} redeemed
                      </Typography>
                    </Box>
                    <LinearProgress
                      variant="determinate"
              ...
              <Grid item xs={12} md={6} key={campaign.id}>
                ...
                >
                  <CardContent>
                    ...
                    <Typography variant="body2" sx={{ mb: 2 }}>
                      <strong>Rewards:</strong> {campaign.rewards.length}{' '}
                      rewards included
                    </Typography>
                    <Box
                ...
                >
                  <CardContent>
                    ...
                    <Typography
                      ...
                      sx={{ mb: 2 }}
                    >
                      Trigger: {automated.trigger.type} -{' '}
                      {automated.trigger.frequency}
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 2 }}>
                      <strong>Reward:</strong> {automated.reward.name} (
                      {automated.reward.coinAmount} coins)
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 2 }}>
                    ...
                    <Typography variant="body2" sx={{ mb: 2 }}>
                      ...
                      {automated.lastTriggered.toLocaleDateString()}
                    </Typography>
                    <Box
                      sx={{ display: 'flex', justifyContent: 'space-between' }}
                    >
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  <CardContent>
                    ...
                    {analytics.topPerformingRewards?.map(
                      (reward: DojoCoinReward, index: number) => (
                        <Box
                          key={reward.id}
                          sx={{
                            display: 'flex',
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  <CardContent>
                    ...
                    {analytics.loyaltyStats?.tierDistribution?.map(
                      (tier: any) => (
                        <Box
                          key={tier.tier}
                          sx={{
      ...
      <Dialog
        open={createRewardDialog}
        onClose={() => setCreateRewardDialog(false)}
        maxWidth="sm"
        fullWidth
      >
            ...
            <Grid item xs={6}>
              <TextField
                ...
                onChange={(e) =>
                  setNewReward({
                    ...newReward,
                    coinAmount: parseInt(e.target.value),
                  })
                }
              />
            </Grid>
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setNewReward({
                      ...newReward,
                      type: e.target.value as DojoCoinReward['type'],
                    })
                  }
                >
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setNewCampaign({
                      ...newCampaign,
                      type: e.target.value as RewardCampaign['type'],
                    })
                  }
                >
                  ...
                  onChange={(e) =>
                    setNewCampaign({
                      ...
                      targetAudience: e.target
                        .value as RewardCampaign['targetAudience'],
                    })
                  }
                >
