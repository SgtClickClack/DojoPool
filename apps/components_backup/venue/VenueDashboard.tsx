...
import { type Venue } from '../../dojopool/frontend/types/venue';
                    ...
                    >
                      <Typography variant="body2">
                        ...
                        {venueData.businessHours
                          .map(
                            (bh) =>
                              `${bh.day}: ${bh.openTime} - ${bh.closeTime}`
                          )
                          .join(', ')}
                      </Typography>
                      <Typography variant="body2">
                        <strong>Contact:</strong>{' '}
                        {venueData.contact.email || venueData.contact.phone}
                      </Typography>
