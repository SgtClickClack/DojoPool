            ...
            {steps.map((step, index) => {
              ...
              return (
                <Step key={step.id}>
                    ...
                    StepIconComponent={() => (
                      <Box
                        sx={{
                          ...
                          color: color,
                          boxShadow:
                            status === 'active' ? `0 0 20px ${color}` : 'none',
                  ...
                  >
                    <Typography
                      ...
                      sx={{
                        ...
                        textShadow:
                          status === 'active' ? `0 0 10px ${color}` : 'none',
                      }}
                    >
                      {step.label}
                    </Typography>
                  ...
                  <StepContent>
                    <Fade in timeout={500}>
                      <Box sx={{ mt: 2, mb: 3 }}>{step.component}</Box>
                    </Fade>
                  </StepContent>
                </Step>
              );
          ...
          <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
            ...
            {gameData.results && (
              <Chip
                icon={<EmojiEvents />}
                label={
                  gameData.results.winner === user?.uid
                    ? 'Victory!'
                    : 'Game Complete'
                }
                sx={{
