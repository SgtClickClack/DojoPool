...
const TournamentSocial: React.FC = () => {
      ...
      posts: [
        {
          ...
          content:
            'Just won the Cyber Championship! What an incredible tournament. Thanks to everyone who supported me throughout this journey. The competition was fierce, but the community made it special! 🏆🎱',
          type: 'achievement',
          ...
          comments: [
            {
              ...
              content:
                'Congratulations! You played amazingly. Looking forward to our next match!',
              likes: 23,
        ...
        },
        {
          ...
          userAvatar: '/avatars/digital-phantom.jpg',
          content:
            'Hosting a defensive strategy workshop this weekend at Cyber Pool LA. Perfect for players looking to improve their safety game. Limited spots available! 🛡️🎱',
          type: 'general',
          likes: 89,
          comments: [],
          shares: 23,
      ...
      events: [
        {
          ...
          description:
            'Join us for an epic watch party as we follow the Cyber Championship finals! Food, drinks, and great company guaranteed.',
          type: 'watch_party',
        ...
        },
        {
          ...
          description:
            'Weekly online meetup to discuss advanced pool strategies and share tips. All skill levels welcome!',
          type: 'meetup',
  ...
  const renderCommunityStats = () => (
    <StyledCard sx={{ mb: 3 }}>
      <CardContent>
        ...
        <List>
          {socialData.stats.topContributors.map(
  ...
  return (
    ...
    >
      ...
      <Box
        sx={{ borderBottom: 1, borderColor: 'rgba(0, 212, 255, 0.3)', mb: 3 }}
      >
        <Tabs
          value={activeTab}
