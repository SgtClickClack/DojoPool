...
import { type PoolGodInteraction } from '../../services/tournament/EnhancedTournamentService';
...
export const EnhancedTournamentPanel: React.FC<
  EnhancedTournamentPanelProps
> = ({ tournamentId, onMatchComplete }) => {
  const {
    tournament,
    currentMatch,
    aiEvents,
  ...
  const [selectedPoolGod, setSelectedPoolGod] =
    useState<PoolGodInteraction | null>(null);
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-blue-100 mt-1">
              {tournament.format} • {tournament.participants?.length || 0}{' '}
              Participants
            </p>
            <p className="text-blue-100 mt-1">
            ...
            {latestPoolGodInteraction ? (
              ...
              >
                ...
                <p className="text-sm text-gray-700">
                  {latestPoolGodInteraction.message}
                </p>
                {latestPoolGodInteraction.blessing && (
                  <div className="mt-2 text-xs text-orange-600">
                    Blessing: {latestPoolGodInteraction.blessing.type} (+
                    {latestPoolGodInteraction.blessing.value})
                  </div>
                )}
              </div>
            ) : (
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {selectedPoolGod.event.replace('_', ' ')}
                </p>
              </div>
            </div>
            ...
            {selectedPoolGod.blessing && (
              <div className="bg-orange-50 border border-orange-200 rounded p-3 mb-4">
                ...
                <div className="text-sm text-orange-700">
                  <div>
                    Type: {selectedPoolGod.blessing.type.replace('_', ' ')}
                  </div>
                  <div>Value: +{selectedPoolGod.blessing.value}</div>
                  <div>
                    Duration: {selectedPoolGod.blessing.duration} seconds
                  </div>
                </div>
              </div>
            )}
