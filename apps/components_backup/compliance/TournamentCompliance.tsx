  ...
  return (
    <Box sx={{ width: '100%', minHeight: '80vh', mt: 2 }}>
      <Paper sx={cyberpunkPaper}>
        <Typography
          variant="h4"
          sx={{ fontWeight: 700, color: '#00fff7', mb: 2, letterSpacing: 2 }}
        >
        ...
        {tab === 0 && (
          <Box>
            <Typography variant="h6" sx={{ color: '#ff00ea', mb: 1 }}>
              Compliance Reports
            </Typography>
                ...
                <Grid item xs={12} md={6} key={r.id}>
                  <Paper sx={{ ...cyberpunkPaper, p: 2, mb: 1 }}>
                    ...
                    >
                      <Typography
                        variant="subtitle1"
                        sx={{ color: '#00fff7', fontWeight: 600 }}
                      >
                        {r.title}
                      </Typography>
                      <Chip
                    ...
                    <Box mt={1} display="flex" gap={1} flexWrap="wrap">
                      ...
                      />
                      <Chip
                        label={`Score: ${r.complianceScore}`}
                        size="small"
                        sx={{ bgcolor: '#222', color: '#00fff7' }}
                      />
                    </Box>
                    <Box mt={1} display="flex" gap={1} flexWrap="wrap">
                      {r.attachments.map((a) => (
                ...
                <Grid item xs={12} md={6} key={v.id}>
                  <Paper sx={{ ...cyberpunkPaper, p: 2, mb: 1 }}>
                    ...
                    >
                      <Typography
                        variant="subtitle1"
                        sx={{ color: '#ff00ea', fontWeight: 600 }}
                      >
                        {v.description}
                      </Typography>
                      <Chip
                        label={v.status}
                        color={v.status === 'resolved' ? 'success' : 'error'}
                        sx={{ ml: 1, fontWeight: 700 }}
                      />
                    </Box>
                    <Typography variant="body2" sx={{ color: '#fff', mt: 1 }}>
                      {v.regulation} - {v.section}
                    </Typography>
                    <Box mt={1} display="flex" gap={1} flexWrap="wrap">
                      <Chip
                        label={v.type}
              ...
              {frameworks.map((f) => (
                <Grid item xs={12} md={6} key={f.id}>
                  <Paper sx={{ ...cyberpunkPaper, p: 2, mb: 1 }}>
                    ...
                    <Typography variant="body2" sx={{ color: '#fff', mt: 1 }}>
                      {f.jurisdiction} - v{f.version}
                    </Typography>
                    <Chip
                      label={f.status}
                      size="small"
                      sx={{ bgcolor: '#ff00ea', color: '#fff', mt: 1 }}
                    />
                    <Typography variant="body2" sx={{ color: '#fff', mt: 1 }}>
                      Compliance Deadline:{' '}
                      {f.complianceDeadline.toLocaleDateString()}
                    </Typography>
                    <Typography variant="body2" sx={{ color: '#fff', mt: 1 }}>
                      Last Review: {f.lastReview.toLocaleDateString()}
                    </Typography>
                    <Typography variant="body2" sx={{ color: '#fff', mt: 1 }}>
                      Next Review: {f.nextReview.toLocaleDateString()}
                    </Typography>
                  </Paper>
                </Grid>
              ))}
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                <Paper sx={{ ...cyberpunkPaper, p: 2, mb: 1 }}>
                  ...
                  <Typography
                    variant="h4"
                    sx={{ color: '#ff00ea', fontWeight: 700 }}
                  >
                    {metrics.overallCompliance}%
                  </Typography>
                  <Box mt={1} display="flex" gap={1} flexWrap="wrap">
                    <Chip
                      label={`Regulatory: ${metrics.regulatoryCompliance}%`}
                      sx={{ bgcolor: '#00fff7', color: '#222' }}
                    />
                    <Chip
                      label={`Operational: ${metrics.operationalCompliance}%`}
                      sx={{ bgcolor: '#ff00ea', color: '#fff' }}
                    />
                    <Chip
                      label={`Security: ${metrics.securityCompliance}%`}
                      sx={{ bgcolor: '#222', color: '#00fff7' }}
                    />
                    <Chip
                      label={`Financial: ${metrics.financialCompliance}%`}
                      sx={{ bgcolor: '#222', color: '#ff00ea' }}
                    />
                  </Box>
                  <Box mt={2}>
                    <Chip
                      label={`Open Violations: ${metrics.openViolations}`}
                      sx={{ bgcolor: '#ff00ea', color: '#fff', mr: 1 }}
                    />
                    <Chip
                      label={`Resolved: ${metrics.resolvedViolations}`}
                      sx={{ bgcolor: '#00fff7', color: '#222' }}
                    />
                  </Box>
                  <Box mt={2}>
                    <Chip
                      label={`Pending Reports: ${metrics.pendingReports}`}
                      sx={{ bgcolor: '#ff00ea', color: '#fff', mr: 1 }}
                    />
                    <Chip
                      label={`Overdue: ${metrics.overdueReports}`}
                      sx={{ bgcolor: '#00fff7', color: '#222' }}
                    />
                  </Box>
                  <Box mt={2}>
                    <Chip
                      label={`Risk: ${metrics.riskLevel}`}
                      sx={{ bgcolor: '#ff00ea', color: '#fff', mr: 1 }}
                    />
                    <Chip
                      label={`Audit: ${metrics.auditStatus}`}
                      sx={{ bgcolor: '#00fff7', color: '#222' }}
                    />
                  </Box>
                  <Box mt={2}>
                    <Typography variant="body2" sx={{ color: '#fff' }}>
                      Next Deadline: {metrics.nextDeadline.toLocaleDateString()}
                    </Typography>
                    <Typography variant="body2" sx={{ color: '#fff' }}>
                      Last Audit: {metrics.lastAudit.toLocaleDateString()}
                    </Typography>
                    <Typography variant="body2" sx={{ color: '#fff' }}>
                      Next Audit: {metrics.nextAudit.toLocaleDateString()}
                    </Typography>
                  </Box>
                </Paper>
              </Grid>
          ...
          <Box>
            ...
            <Paper sx={{ ...cyberpunkPaper, p: 2, mb: 1 }}>
              <Typography
                ...
                sx={{ color: '#00fff7', fontWeight: 600 }}
              >
                Auto Reporting: {config.autoReporting ? 'Enabled' : 'Disabled'}
              </Typography>
              <Typography
                variant="subtitle1"
                sx={{ color: '#00fff7', fontWeight: 600 }}
              >
                ...
                {config.realTimeMonitoring ? 'Enabled' : 'Disabled'}
              </Typography>
              <Typography
                variant="subtitle1"
                sx={{ color: '#00fff7', fontWeight: 600 }}
              >
                ...
                {config.automatedAssessments ? 'Enabled' : 'Disabled'}
              </Typography>
              <Box mt={2}>
                <Typography variant="body2" sx={{ color: '#fff' }}>
                ...
                <Typography variant="body2" sx={{ color: '#fff' }}>
                  Jurisdictions: {config.jurisdictions.join(', ')}
                </Typography>
              </Box>
            </Paper>
          </Box>
