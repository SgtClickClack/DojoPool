...
import type { TournamentAnalytics as TournamentAnalyticsType } from '../../services/analytics/TournamentAnalyticsService';
      ...
      <Box sx={{ mb: 4 }}>
        ...
        >
          {isConnected
            ...
            : 'Disconnected from analytics service'}
        </Alert>
      </Box>
                    ...
                    <LinearProgress
                      ...
                      sx={{
                        ...
                        '& .MuiLinearProgress-bar': {
                          bgcolor:
                            getStatusColor(player.winRate, 0.5) === 'success'
                              ? '#00ff9d'
                              : getStatusColor(player.winRate, 0.5) ===
                                  'warning'
                                ? '#feca57'
                                : '#ff6b6b',
                        },
              ...
              <Card sx={{ bgcolor: '#1a1a1a', border: '1px solid #333' }}>
                <CardContent>
                  ...
                  <Box sx={{ mb: 2 }}>
                    <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
                      Completion Rate:{' '}
                      {formatPercentage(tournament.completionRate)}
                    </Typography>
                    <LinearProgress
                      variant="determinate"
                      ...
                      sx={{
                        ...
                        '& .MuiLinearProgress-bar': {
                          bgcolor:
                            getStatusColor(tournament.completionRate, 0.8) ===
                            'success'
                              ? '#00ff9d'
                              : getStatusColor(
                                    tournament.completionRate,
                                    0.8
                                  ) === 'warning'
                                ? '#feca57'
                                : '#ff6b6b',
              ...
              <Card sx={{ bgcolor: '#1a1a1a', border: '1px solid #333' }}>
                <CardContent>
                  ...
                  <Box sx={{ mb: 2 }}>
                    ...
                    <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
                      Win Probability:{' '}
                      {formatPercentage(insight.winProbability)}
                    </Typography>
                    <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
                  ...
                  <Box sx={{ mb: 2 }}>
                    <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
                      Expected Duration: {Math.round(insight.expectedDuration)}{' '}
                      minutes
                    </Typography>
                    <Typography variant="body2" sx={{ color: '#888', mb: 1 }}>
                    ...
                    <Typography variant="body2" sx={{ color: '#00a8ff' }}>
                      Revenue Forecast:{' '}
                      {formatCurrency(insight.revenueForecast)}
                    </Typography>
                  </Box>
        ...
        <Card sx={{ bgcolor: '#1a1a1a', border: '1px solid #333' }}>
          <CardContent>
            ...
            <Alert severity="info" icon={<Info />}>
              Reports include comprehensive analytics data, insights, and
              recommendations based on current tournament performance.
            </Alert>
          </CardContent>
        </Card>
      </TabPanel>
