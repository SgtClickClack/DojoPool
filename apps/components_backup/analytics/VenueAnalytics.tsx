...
import VenueAnalyticsService, {
  ...
  type VenueHealthStatus,
  type VenueROIAnalysis,
...
const VenueAnalytics: React.FC = () => {
  ...
  const [venueComparison, setVenueComparison] =
    useState<VenueComparison | null>(null);
  const [predictiveInsights, setPredictiveInsights] =
    useState<PredictiveInsights | null>(null);
  const [healthStatus, setHealthStatus] = useState<VenueHealthStatus | null>(
    null
  );
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={6}>
                      ...
                      <Typography variant="h5" sx={{ color: '#fff' }}>
                        ${venueMetrics.revenue.daily.toLocaleString()}
                      </Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <Typography variant="body2" sx={{ color: '#888' }}>
                ...
                <CardContent>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={6}>
                      ...
                      <Typography variant="h5" sx={{ color: '#fff' }}>
                        {venueMetrics.playerEngagement.activePlayers}
                      </Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <Typography variant="body2" sx={{ color: '#888' }}>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={6}>
                      ...
                      <Typography variant="h6" sx={{ color: '#feca57' }}>
                        {
                          venueMetrics.tournamentPerformance
                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12} md={4}>
                      ...
                      >
                        <Typography
                          variant="h4"
                          sx={{ color: '#00ff9d', mr: 2 }}
                        >
                          #{venueComparison.metrics.revenueComparison.rank}
                        </Typography>
                        <Typography variant="body2" sx={{ color: '#888' }}>
                          Top{' '}
                          {venueComparison.metrics.revenueComparison.percentile}
                          %
                        </Typography>
                      </Box>
                    </Grid>
                    <Grid item xs={12} md={4}>
                      ...
                      >
                        <Typography
                          variant="h4"
                          sx={{ color: '#00a8ff', mr: 2 }}
                        >
                          #
                          {
                            venueComparison.metrics.playerEngagementComparison
                              .rank
                          }
                        </Typography>
                        <Typography variant="body2" sx={{ color: '#888' }}>
                    ...
                    <Grid item xs={12} md={4}>
                      ...
                      >
                        <Typography
                          variant="h4"
                          sx={{ color: '#feca57', mr: 2 }}
                        >
                          #
                          {
                            venueComparison.metrics
                              .tournamentPerformanceComparison.rank
                          }
                        </Typography>
                        <Typography variant="body2" sx={{ color: '#888' }}>
                          Top{' '}
                          {
                            venueComparison.metrics
                              .tournamentPerformanceComparison.percentile
                          }
                          %
                        </Typography>
                      </Box>
                ...
                <CardContent>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={4}>
                      ...
                      <Typography variant="h6" sx={{ color: '#00ff9d' }}>
                        {
                          predictiveInsights.predictions.revenueForecast
                            .confidence
                        }
                        %
                      </Typography>
                ...
                <CardContent>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={6}>
                      ...
                      <Typography variant="h6" sx={{ color: '#fff' }}>
                        {
                          predictiveInsights.predictions.playerGrowth
                            .expectedNewPlayers
                        }
                      </Typography>
                    </Grid>
            ...
            <Grid item xs={12}>
              ...
              >
                <CardContent>
                  ...
                  <Grid container spacing={2}>
                    {Object.entries(
                      predictiveInsights.optimizationRecommendations
              ...
              >
                <CardContent>
                  ...
                  <Grid container spacing={1}>
                    {Object.entries(healthStatus.systemStatus).map(
                      ([system, status]) => (
                        <Grid item xs={6} key={system}>
                          ...
                          >
                            {status === 'online' ? (
                              <CheckCircle
                                sx={{ color: '#00ff9d', fontSize: 16 }}
                              />
                            ) : status === 'degraded' ? (
                              <Warning
                                sx={{ color: '#feca57', fontSize: 16 }}
                              />
                            ) : (
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <CardContent>
                  ...
                  <Grid container spacing={2}>
                    {Object.entries(healthStatus.equipmentStatus).map(
                      ([equipment, status]) => (
