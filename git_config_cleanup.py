...
def cleanup_git_configuration():
    ...
    try:
        ...
        redundant_files = [
            ...
            'git_settings.py', 'git_manager_optimized.py'
        ]
...
if __name__ == "__main__":
    success = cleanup_git_configuration()
    if success:
        logger.info("Git configuration optimized and files cleaned up successfully")
        exit(0)
    else:
