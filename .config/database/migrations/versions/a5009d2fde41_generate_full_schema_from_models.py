"""generate_full_schema_from_models

Revision ID: a5009d2fde41
Revises: 3f1347db2a6c
Create Date: 2025-05-12 02:28:23.509397
...
revision = 'a5009d2fde41'
down_revision = '3f1347db2a6c'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('core_game_model',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('received_bye_round', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['tournament_id'], ['tournaments.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('marketplace_item_id', sa.Integer(), nullable=True),
    sa.Column('amount', sa.Float(), nullable=False),
    sa.Column('currency', sa.String(length=10), nullable=False),
    sa.Column('type', sa.String(length=50), nullable=False),
    ...
    sa.Column('potting_success', sa.Float(), nullable=True),
    sa.Column('position_control', sa.Float(), nullable=True),
    sa.Column('safety_success', sa.Float(), nullable=True),
    sa.Column('break_success', sa.Float(), nullable=True),
    sa.Column('total_shots', sa.Integer(), nullable=True),
    sa.Column('successful_shots', sa.Integer(), nullable=True),
    sa.Column('failed_shots', sa.Integer(), nullable=True),
    sa.Column('fouls', sa.Integer(), nullable=True),
    sa.Column('safeties_played', sa.Integer(), nullable=True),
    sa.Column('points_scored', sa.Integer(), nullable=True),
    sa.Column('shot_patterns', sa.JSON(), nullable=True),
    sa.Column('position_patterns', sa.JSON(), nullable=True),
    sa.Column('game_progression', sa.JSON(), nullable=True),
