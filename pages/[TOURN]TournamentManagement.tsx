...
import { Tournament, TournamentMatch, TournamentStatus, TournamentFormat } from '../../types/tournament';
...
export const TournamentManagement: React.FC = () => {
  ...
  const handleMatchClick = async (match: TournamentMatch) => {
    if (match.status === 'in_progress' && user?.id === selectedTournament?.organizerId) {
      ...
      <Container maxWidth="lg">
        ...
        >
                          ...
                          <Grid container spacing={2}>
                            <Grid item xs={12} sm={6}>
                              <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1 }}>
                                <Schedule sx={{ color: '#ff00ff', fontSize: 20 }} />
                                <Typography variant="body2" sx={{ color: '#cccccc' }}>
                                  Start: {new Date(tournament.startDate).toLocaleString()}
                                </Typography>
                              </Stack>
                              <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1 }}>
                                <People sx={{ color: '#00ff00', fontSize: 20 }} />
                                <Typography variant="body2" sx={{ color: '#cccccc' }}>
                            ...
                            <Grid item xs={12} sm={6}>
                              <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1 }}>
                                <AttachMoney sx={{ color: '#ffff00', fontSize: 20 }} />
                                <Typography variant="body2" sx={{ color: '#cccccc' }}>
                                  Entry Fee: ${tournament.entryFee || 0}
                                </Typography>
                              </Stack>
                              <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1 }}>
                                <EmojiEvents sx={{ color: '#ff8800', fontSize: 20 }} />
                                <Typography variant="body2" sx={{ color: '#cccccc' }}>
                          ...
                          <Stack direction="row" spacing={1}>
                            ...
                            {tournament.status === TournamentStatus.OPEN && (
                              <Button
                                variant="contained"
                                startIcon={<PlayArrow />}
                                onClick={() => handleRegisterForTournament(Number(tournament.id))}
                                sx={{
          ...
          <TabPanel value={tabValue} index={2}>
            <Typography variant="h6" sx={{ color: '#888888', textAlign: 'center', py: 4 }}>
