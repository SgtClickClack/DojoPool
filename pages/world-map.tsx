...
import { LocationOn, Business, Star, AccessTime, EmojiEvents, Group, TrendingUp } from '@mui/icons-material';
              ...
              <CardContent>
                ...
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
                  <Box sx={{ textAlign: 'center', minWidth: '80px' }}>
                    <Typography variant="body2" sx={{ color: '#ccc' }}>Level</Typography>
                    <Typography variant="h6" sx={{ color: '#00ff9d' }}>{playerStats.level}</Typography>
                  </Box>
                  <Box sx={{ textAlign: 'center', minWidth: '80px' }}>
                    <Typography variant="body2" sx={{ color: '#ccc' }}>Win Rate</Typography>
                    <Typography variant="h6" sx={{ color: '#00ff9d' }}>{playerStats.winRate}%</Typography>
                  </Box>
                  <Box sx={{ textAlign: 'center', minWidth: '80px' }}>
                    <Typography variant="body2" sx={{ color: '#ccc' }}>Streak</Typography>
                    <Typography variant="h6" sx={{ color: '#00ff9d' }}>{playerStats.currentStreak}</Typography>
                  </Box>
                  <Box sx={{ textAlign: 'center', minWidth: '80px' }}>
                    <Typography variant="body2" sx={{ color: '#ccc' }}>Clan Rank</Typography>
                    <Typography variant="h6" sx={{ color: '#00ff9d' }}>{playerStats.clanRank}</Typography>
                  </Box>
                </Box>
              </CardContent>
            </Card>
              ...
              <CardContent>
                ...
                {currentObjectives.map((objective) => (
                  <Box key={objective.id} sx={{ mb: 2 }}>
                    ...
                    <Typography variant="caption" sx={{ color: '#00a8ff', mt: 0.5, display: 'block' }}>
                      {objective.progress}/{objective.maxProgress} - {objective.reward}
                    </Typography>
                  </Box>
                ))}
              </CardContent>
            ...
            {territories.map((territory) => (
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                  <LocationOn sx={{ color: territory.color, mr: 1, fontSize: 24 }} />
                  <Typography
                    variant="h6"
                    sx={{
                ...
                <Box sx={{ 
                  ...
                  mb: 2,
                  borderRadius: 1,
                  backgroundColor: territory.status === 'controlled' ? '#00ff9d' : 
                                   territory.status === 'rival' ? '#ff6b6b' : '#00a8ff',
                  color: '#000',
                  fontWeight: 'bold',
                  fontSize: '0.8rem'
                }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <Group sx={{ color: territory.color, fontSize: 16, mr: 0.5 }} />
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <TrendingUp sx={{ color: territory.color, fontSize: 16, mr: 0.5 }} />
                  <Typography variant="body2" sx={{ color: '#fff', mr: 2 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <Business sx={{ color: territory.color, fontSize: 16, mr: 0.5 }} />
