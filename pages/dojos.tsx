...
import EditDojoModal from '../src/frontend/components/EditDojoModal';
import { Dojo } from '../src/frontend/services/dojo.service';
...
const DojosPage: React.FC = () => {
  ...
  const handleDeleteDojo = (dojoId: string) => {
    console.log('Delete button clicked for dojo ID:', dojoId);
              ...
              <CardContent>
                ...
                <Box display="flex" gap={1}>
                  <Button
                    ...
                    size="small"
                    color="primary"
                    onClick={() => router.push(`/dojo/${dojo.id}`)}
                    sx={{ flex: 1 }}
                  >
                    View Details
                  </Button>
