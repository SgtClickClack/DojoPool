...
const AdvancedChallengePanel: React.FC = () => {
  ...
  return (
    <Box p={6}>
      <Heading size="lg" mb={6}>Advanced Challenges</Heading>
      
      <Tabs onChange={(index) => setActiveTab(index === 0 ? 'tournament' : 'clan')}>
        <TabList>
        ...
        <TabPanels>
          <TabPanel>
            <VStack spacing={6} align="stretch">
              <Box p={4} borderWidth={1} borderRadius="md">
                <Heading size="md" mb={4}>Create Tournament Challenge</Heading>
                <Text mb={4}>Organize large-scale tournaments with multiple participants, brackets, and prizes.</Text>
              ...
              <Box p={4} borderWidth={1} borderRadius="md">
                <Heading size="md" mb={4}>Active Tournaments</Heading>
                <VStack spacing={3} align="stretch">
                  <Box p={3} borderWidth={1} borderRadius="md">
                    <HStack justify="space-between">
                      <VStack align="start" spacing={1}>
                        <Text fontWeight="bold">Brisbane Masters</Text>
                        <Text fontSize="sm" color="gray.600">16 participants • Single Elimination</Text>
                        <Text fontSize="sm" color="gray.600">Entry Fee: 100 coins</Text>
                      </VStack>
          ...
          <TabPanel>
            <VStack spacing={6} align="stretch">
              <Box p={4} borderWidth={1} borderRadius="md">
                <Heading size="md" mb={4}>Create Clan Challenge</Heading>
                <Text mb={4}>Challenge other clans for territory control and diplomatic influence.</Text>
              ...
              <Box p={4} borderWidth={1} borderRadius="md">
                <Heading size="md" mb={4}>Active Clan Wars</Heading>
                <VStack spacing={3} align="stretch">
                  <Box p={3} borderWidth={1} borderRadius="md">
                    <HStack justify="space-between">
                      <VStack align="start" spacing={1}>
                        <Text fontWeight="bold">Crimson Dragons vs Shadow Wolves</Text>
                        <Text fontSize="sm" color="gray.600">Territory Stakes: 3 dojos</Text>
                        <Text fontSize="sm" color="gray.600">Diplomatic Implications: High</Text>
                      </VStack>
...
const AdvancedMovementPanel: React.FC = () => {
  ...
  const teleportToDojo = async (teleportType: 'instant' | 'ritual' | 'clan_gate') => {
    try {
      const gameMechanics = new GameMechanicsService();
      const movement = await gameMechanics.teleportToDojo(selectedDojo, teleportType);
  ...
  const fastTravelToDojo = async (fastTravelType: 'clan_network' | 'alliance_network' | 'premium') => {
    try {
      const gameMechanics = new GameMechanicsService();
      const movement = await gameMechanics.fastTravelToDojo(selectedDojo, fastTravelType);
  ...
  return (
    <Box p={6}>
      <Heading size="lg" mb={6}>Advanced Movement</Heading>
      
      <Grid templateColumns="repeat(2, 1fr)" gap={6}>
        <GridItem>
          <Box p={4} borderWidth={1} borderRadius="md">
            <Heading size="md" mb={4}>Teleportation</Heading>
            <Text mb={4}>Instant or ritual-based teleportation to any dojo.</Text>
            <VStack spacing={3} align="stretch">
              <Button colorScheme="purple" onClick={() => teleportToDojo('instant')}>
                Instant Teleport (High Cost)
              </Button>
              <Button colorScheme="blue" onClick={() => teleportToDojo('ritual')}>
                Ritual Teleport (Medium Cost)
              </Button>
              <Button colorScheme="green" onClick={() => teleportToDojo('clan_gate')}>
                Clan Gate (Low Cost)
              </Button>
            </VStack>
          </Box>
        ...
        <GridItem>
          <Box p={4} borderWidth={1} borderRadius="md">
            <Heading size="md" mb={4}>Fast Travel Networks</Heading>
            <Text mb={4}>Use clan, alliance, or premium networks for faster travel.</Text>
            <VStack spacing={3} align="stretch">
              <Button colorScheme="orange" onClick={() => fastTravelToDojo('clan_network')}>
                Clan Network (10 min)
              </Button>
              <Button colorScheme="teal" onClick={() => fastTravelToDojo('alliance_network')}>
                Alliance Network (15 min)
              </Button>
              <Button colorScheme="pink" onClick={() => fastTravelToDojo('premium')}>
...
const TerritoryAlliancePanel: React.FC = () => {
  ...
  return (
    <Box p={6}>
      <Heading size="lg" mb={6}>Territory Alliances & Diplomacy</Heading>
      
      <Grid templateColumns="repeat(2, 1fr)" gap={6}>
        <GridItem>
          <Box p={4} borderWidth={1} borderRadius="md">
            <Heading size="md" mb={4}>Alliances</Heading>
            <Text mb={4}>Form alliances with other clans for shared territory control.</Text>
        ...
        <GridItem>
          <Box p={4} borderWidth={1} borderRadius="md">
            <Heading size="md" mb={4}>Trade Agreements</Heading>
            <Text mb={4}>Establish trade agreements for resource exchange.</Text>
