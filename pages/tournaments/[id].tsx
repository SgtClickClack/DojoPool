...
import { getTournament, submitMatchResult } from '@/frontend/api/tournaments';
import TournamentBracket from '@/components/tournament/TournamentBracket';
import MatchResultDialog from '@/components/tournament/MatchResultDialog';
import PageBackground from '@/components/common/PageBackground';
import { Tournament, TournamentBracket as TournamentBracketType, TournamentMatch } from '@/types/tournament';

// Add a function to fetch tournament bracket data
const fetchTournamentBracket = async (tournamentId: string): Promise<TournamentBracketType> => {
  try {
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} md={4}>
                <Card sx={cyberCardStyle}>
                  <CardContent>
                    <Typography variant="h6" sx={{ ...neonTextStyle, mb: 3, fontSize: '1.2rem' }}>
                      Tournament Details
                    </Typography>
                    ...
                    <Divider sx={{ my: 2, borderColor: 'rgba(0, 255, 157, 0.2)' }} />
                    ...
                    {tournament.rules && (
                      <Box sx={{ mt: 3 }}>
                        <Typography sx={{ color: '#888', fontWeight: 600, mb: 1 }}>
                          Rules:
                        </Typography>
