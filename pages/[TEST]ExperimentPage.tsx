...
const SAMPLE_EXPERIMENTS: ExperimentInfo[] = [
    {
        ...
        description: 'Testing different compression quality settings for optimal file size vs. visual quality.',
        startDate: '2024-03-01'
    },
    {
        id: 'loading_strategy_test',
        name: 'Image Loading Strategy',
        description: 'Comparing eager vs. lazy loading for different page sections.',
