-- PostgreSQL initialization for Asia Pacific region (Chaos Testing)
...
CREATE TABLE IF NOT EXISTS dojopool_test.health_check (
    ...
    region VARCHAR(50) DEFAULT 'asia-pacific',
...
INSERT INTO dojopool_test.health_check (region, status) VALUES
    ('asia-pacific', 'healthy'),
    ('asia-pacific', 'healthy');

INSERT INTO dojopool_test.users (email, username) VALUES
    ('ap-test1@example.com', 'aptestuser1'),
    ('ap-test2@example.com', 'aptestuser2');
