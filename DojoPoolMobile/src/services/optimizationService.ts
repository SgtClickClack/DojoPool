...
class OptimizationService {
  ...
  private async saveSettings() {
    await AsyncStorage.setItem('optimizationSettings', JSON.stringify(this.settings));
  }
  ...
  private async savePerformanceMetrics() {
    await AsyncStorage.setItem('performanceMetrics', JSON.stringify(this.performanceMetrics));
  }
